...
project.scorers.create({
    ...
    handler: async ({ output }) => {
        ...
        if (questionMarks === 0)
            return { score: 1.0, metadata: { questionCount: 0, status: "no_questions" } };
        if (questionMarks === 1)
            return { score: 1.0, metadata: { questionCount: 1, status: "single_question" } };
...
//# sourceMappingURL=mpa-braintrust-scorers.js.map