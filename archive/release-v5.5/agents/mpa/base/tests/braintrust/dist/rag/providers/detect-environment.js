...
export function detectEnvironment() {
    ...
    const hasCopilotStudio = !!(process.env.COPILOT_STUDIO_ENDPOINT &&
        process.env.COPILOT_STUDIO_KEY);
    const hasDataverse = !!(process.env.DATAVERSE_URL &&
        process.env.DATAVERSE_CLIENT_ID &&
        process.env.DATAVERSE_CLIENT_SECRET);
    const hasAzureSearch = !!(process.env.AZURE_AI_SEARCH_ENDPOINT &&
