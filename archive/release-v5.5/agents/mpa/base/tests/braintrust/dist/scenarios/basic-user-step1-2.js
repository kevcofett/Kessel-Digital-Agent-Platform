    ...
    failureConditions: [
        {
            ...
            type: "custom_pattern",
            detectionPattern: "incrementality|attribution model|lift study|holdout|MMM|media mix model",
            severity: "major",
            scorePenalty: 0.15,
        ...
        },
        {
            ...
            type: "custom_pattern",
            detectionPattern: "what is your LTV|lifetime value|profit margin|ROAS target",
            severity: "warning",
            scorePenalty: 0.05,
            terminateOnDetect: false,
        },
        ...
        customCriteria: [
            {
                ...
                evaluator: (result) => {
                    return result.allEvents.some((e) => e.type === "calculation_performed");
                },
            },
            {
                ...
                evaluator: (result) => {
                    const jargonPattern = /\b(CAC|LTV|ROAS|CPM|CPA|CPC|incrementality|attribution)\b/gi;
