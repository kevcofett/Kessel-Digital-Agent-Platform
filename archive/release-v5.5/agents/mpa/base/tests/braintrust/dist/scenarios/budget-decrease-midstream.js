...
export const budgetDecreasePersona = {
    ...
    knownData: {
        ...
        audienceDescription: "Enterprise companies (5000+ employees) with data engineering teams, " +
 ...
 */
const budgetDecreaseChange = {
    triggerTurn: 7,
    field: "budget",
    oldValue: 1000000,
    newValue: 600000,
    userMessage: "I just got out of a budget review meeting and I have bad news. " +
    ...
    failureConditions: [
        {
            ...
            description: "Agent continues with old $1M budget after user announced cut",
            type: "custom_pattern",
            severity: "critical",
            scorePenalty: 0.30,
        ...
        },
        {
            ...
            description: "Agent acknowledged cut but did not recalculate efficiency metrics",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.20,
            terminateOnDetect: false,
        },
        {
            ...
            description: "Agent did not recommend what to cut or prioritize with reduced budget",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.15,
            terminateOnDetect: false,
        },
        {
            ...
            description: "Agent suggests 40% budget cut won't significantly impact results",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.15,
            terminateOnDetect: false,
