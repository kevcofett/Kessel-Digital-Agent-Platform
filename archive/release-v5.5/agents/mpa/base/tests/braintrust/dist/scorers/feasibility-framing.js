 ...
 */
function hasFeasibilityLanguage(response) {
 ...
 */
function hasBadFeasibilityPatterns(response) {
    const badPatterns = [
 ...
 */
export async function scoreFeasibilityFraming(ctx) {
...
//# sourceMappingURL=feasibility-framing.js.map