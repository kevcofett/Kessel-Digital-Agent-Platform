...
context: {{context}}
candidate sentences: `;
var relevantSentencesSchema = z.object({
  sentences: z.array(
    z.object({
...
classification:
`;
var contextRecallSchema = z.object({
  statements: z.array(
    z.object({
      statement: z.string(),
      attributed: z.number(),
...
verification:
`;
var contextPrecisionSchema = z.object({
...
answer:
`;
var extractedStatementsSchema = z.object({
  statements: z.array(z.string()).describe("the list of extracted statements")
});
var statementFaithfulnessSchema = z.object({
...
output:
`;
var questionGenSchema = z.object({
  question: z.string(),
...
`;
var answerCorrectnessClassificationSchema = z.object({
  TP: z.array(z.string()),
  FP: z.array(z.string()),
  FN: z.array(z.string())
});
