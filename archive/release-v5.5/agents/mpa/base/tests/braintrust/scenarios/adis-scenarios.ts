...
import { TestScenario, UserPersona, ConversationTurn, QualityContext, ScenarioSuccessCriteria } from "../mpa-multi-turn-types.js";

// ============================================================================
// Personas
// ============================================================================

export const dataRichRetailPersona: UserPersona = {
  ...
  priorMediaExperience:
    "Retail marketing manager with 3 years of transaction data for 50,000 customers. " +
...
export const customerValueFocusedPersona: UserPersona = {
  ...
  priorMediaExperience:
    "VP Marketing at subscription SaaS company. Has detailed customer cohort data " +
...
export const segmentationNewbiePersona: UserPersona = {
  ...
  priorMediaExperience:
    "Small ecommerce business owner. Has customer purchase history in spreadsheets " +
...
const adisTriggerTurns: ConversationTurn[] = [
  {
    turnNumber: 1,
  ...
  },
  {
    turnNumber: 5,
    userMessage:
      "RFM sounds perfect. My data has customer ID, purchase date, and order amount. " +
...
export const adisTriggerContext: QualityContext = {
  scenarioType: "adis-integration",
  vertical: "retail",
};

export const adisTriggerScenario: TestScenario = {
  id: "adis-trigger-detection",
  name: "ADIS Trigger Detection",
  category: "adis",
  description:
    "Tests that the agent correctly identifies customer data mentions and offers ADIS analysis. " +
...
const rfmAudienceCreationTurns: ConversationTurn[] = [
  {
    turnNumber: 1,
    userMessage:
      "I want to run RFM analysis on my customer base to identify segments for a holiday campaign",
    expectedBehaviors: [
  ...
  },
  {
    turnNumber: 2,
    userMessage:
      "I have an Excel file with 50,000 customers and 180,000 transactions over 2 years. Ready to upload.",
    expectedBehaviors: [
...
export const rfmAudienceCreationContext: QualityContext = {
  scenarioType: "adis-rfm-workflow",
  vertical: "retail",
  channels: ["email", "direct_mail", "programmatic", "paid_social"],
};

export const rfmAudienceCreationScenario: TestScenario = {
  id: "rfm-audience-creation",
  name: "RFM Analysis and Audience Creation",
  category: "adis",
  description:
    "Tests full RFM workflow: analysis execution, segment presentation, audience creation, " +
...
const ammoBudgetOptimizationTurns: ConversationTurn[] = [
  {
    turnNumber: 1,
    userMessage:
      "I have Champions and At Risk audiences from my RFM analysis. Now I need to allocate my $500K budget.",
    expectedBehaviors: [
...
export const ammoBudgetOptimizationContext: QualityContext = {
  scenarioType: "adis-ammo-workflow",
  vertical: "retail",
  channels: ["email", "direct_mail", "programmatic", "paid_social", "paid_search"],
};

export const ammoBudgetOptimizationScenario: TestScenario = {
  id: "ammo-budget-optimization",
  name: "AMMO Budget Optimization",
  category: "adis",
  description:
    "Tests AMMO integration: budget optimization offer, allocation presentation, " +
...
const clvAnalysisTurns: ConversationTurn[] = [
  {
    turnNumber: 1,
    userMessage:
      "I need to justify our CAC investments to the board. Can you help me calculate customer lifetime value?",
    expectedBehaviors: [
  ...
  },
  {
    turnNumber: 2,
    userMessage:
      "We have 18 months of subscription data. 12,000 customers, monthly recurring revenue, churn events tracked.",
    expectedBehaviors: [
...
export const clvAnalysisContext: QualityContext = {
  scenarioType: "adis-clv-workflow",
  vertical: "subscription",
};

export const clvAnalysisScenario: TestScenario = {
  id: "clv-analysis-sophisticated",
  name: "CLV Analysis for Sophisticated User",
  category: "adis",
  description:
    "Tests CLV workflow with sophisticated user: model recommendation, " +
...
const segmentationNewbieTurns: ConversationTurn[] = [
  {
    turnNumber: 1,
    userMessage:
      "I know I have good customers and bad customers but I don't know how to tell them apart systematically",
    expectedBehaviors: [
...
export const segmentationNewbieContext: QualityContext = {
  scenarioType: "adis-basic-user",
  vertical: "ecommerce",
};

export const segmentationNewbieScenario: TestScenario = {
  id: "segmentation-newbie-user",
  name: "Segmentation for Newbie User",
  category: "adis",
  description:
    "Tests ADIS integration with basic user: language adaptation, " +
...
export const ADIS_SCENARIOS: TestScenario[] = [
  adisTriggerScenario,
...
export const ADIS_CONTEXTS: Record<string, QualityContext> = {
