 ...
 */
export const audienceAdditionPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "High-net-worth individuals 55+ approaching or in retirement", // Initial single segment
    hasGeography: true,
 ...
 */
const audienceAdditionChange: DataChange = {
  triggerTurn: 8,
  field: "audiences",
  oldValue: [
    {
  ...
  userMessage:
    "I need to expand our scope. After our strategy meeting, leadership wants us to also target " +
 ...
 */
export const audienceAdditionChangeScenario: TestScenario = {
  id: "audience-addition-change",
  name: "Audience Addition Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals additional audience segment mid-conversation. " +
  ...
  openingMessage:
    "Hi, I'm VP of Marketing at WealthPath Advisors, a wealth management firm. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with single audience strategy after user added second segment",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged new segment but did not provide budget allocation",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent used identical strategy for vastly different age segments",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
    ...
    customCriteria: [
      ...
      },
      {
        ...
        evaluator: (result) => {
          ...
          const matchCount = allocationPatterns.filter((p) =>
