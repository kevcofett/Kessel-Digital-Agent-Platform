 ...
 */
export const audienceRemovalPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Three segments: (1) Eco-conscious early adopters 25-45, " +
 ...
 */
const audienceRemovalChange: DataChange = {
  triggerTurn: 8,
  field: "audiences",
  oldValue: [
    {
  ...
  userMessage:
    "We need to simplify things. After reviewing the budget more closely, we can't effectively " +
 ...
 */
export const audienceRemovalChangeScenario: TestScenario = {
  id: "audience-removal-change",
  name: "Audience Removal Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user removes audience segment mid-conversation. " +
  ...
  openingMessage:
    "Hi, I'm Director of Marketing at ElectraDrive Motors. We're launching a new EV and " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with 3-segment strategy after user dropped one",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      id: "no-reallocation",
      description:
        "Agent acknowledged removal but did not reallocate budget to remaining segments",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent continued recommending tactics for removed segment",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
