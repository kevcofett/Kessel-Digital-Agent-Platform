 ...
 */
export const budgetRevisionPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Mid-market companies (100-1000 employees) looking for data analytics solutions",
    hasGeography: true,
    geography: ["US", "Canada"],
 ...
 */
const budgetIncreaseChange: DataChange = {
  triggerTurn: 6,
  field: "budget",
  oldValue: 500000,
  newValue: 750000,
  userMessage:
    "Oh wait, I just got word from finance - our budget was approved for $750K, not $500K! " +
 ...
 */
export const budgetRevisionMidstreamScenario: TestScenario = {
  id: "budget-revision-midstream",
  name: "Budget Revision Midstream",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals budget increase mid-conversation. " +
    "Agent MUST recalculate, explain impact, and recommend allocation changes.",

  persona: budgetRevisionPersona,

  openingMessage:
    "Hi, I'm the Director of Marketing at CloudMetrics, a B2B analytics SaaS company. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with old $500K budget after user announced increase",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged change but did not recalculate affected metrics",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent did not recommend how to use the additional $250K",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
