 ...
 */
export const channelMixChangePersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Health-conscious families, 25-54, with household income $75K+, " +
 ...
 */
const channelExclusionChange: DataChange = {
  triggerTurn: 8,
  field: "channelExclusions",
  oldValue: [],
  newValue: ["Meta", "Facebook", "Instagram", "TikTok"],
  userMessage:
    "I need to flag something important - I just got out of a call with our legal and brand safety team. " +
 ...
 */
export const channelMixChangeScenario: TestScenario = {
  id: "channel-mix-change",
  name: "Channel Mix Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals channel exclusions mid-conversation. " +
    "Agent MUST recalculate allocations, explain impact, and recommend alternatives.",

  persona: channelMixChangePersona,

  openingMessage:
    "Hi, I'm a Senior Brand Manager at PureLife Organics. We're launching a new organic snack line " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues recommending Meta/TikTok after user banned them",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged exclusion but did not revise channel allocations",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent did not recommend alternative channels to replace social",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
    ...
    customCriteria: [
      ...
      },
      {
        ...
        evaluator: (result) => {
          ...
          const hasExcludedChannel = excludedChannelMentions.some((p) =>
            p.test(postChangeResponses)
          );
          ...
          const hasAlternative = alternativePatterns.some((p) =>
            p.test(postChangeResponses)
          );
