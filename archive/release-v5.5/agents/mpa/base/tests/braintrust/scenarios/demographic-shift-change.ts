 ...
 */
export const demographicShiftPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Millennials 25-40 interested in streetwear and urban fashion", // Initial - will change
    hasGeography: true,
 ...
 */
const demographicShiftChange: DataChange = {
  triggerTurn: 8,
  field: "demographics",
  oldValue: { ageRange: "25-40", generation: "Millennials" },
  newValue: { ageRange: "18-27", generation: "Gen Z" },
  userMessage:
    "Hold on - I just got the results from our consumer research study. " +
 ...
 */
export const demographicShiftChangeScenario: TestScenario = {
  id: "demographic-shift-change",
  name: "Demographic Shift Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals demographic target shift mid-conversation. " +
  ...
  openingMessage:
    "Hey, I'm Marketing Manager at UrbanStyle Collective, a streetwear brand. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with Millennial strategy after user pivoted to Gen Z",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged shift but did not adjust channel recommendations",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent kept exact same channel mix despite major demographic change",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
