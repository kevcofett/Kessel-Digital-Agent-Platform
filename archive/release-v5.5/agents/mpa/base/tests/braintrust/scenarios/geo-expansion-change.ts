 ...
 */
export const geoExpansionPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Active adults 25-45, fitness enthusiasts, mid-to-high household income",
    hasGeography: true,
 ...
 */
const geoExpansionChange: DataChange = {
  triggerTurn: 7,
  field: "geography",
  oldValue: ["US"],
  newValue: ["US", "Canada", "Mexico"],
  userMessage:
    "Update on scope - I just found out we're getting distribution in Canada and Mexico starting next quarter. " +
 ...
 */
export const geoExpansionChangeScenario: TestScenario = {
  id: "geo-expansion-change",
  name: "Geography Expansion Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals geography expansion mid-conversation. " +
    "Agent MUST recalculate allocations, explain complexity, and recommend market prioritization.",

  persona: geoExpansionPersona,

  openingMessage:
    "Hi, I'm Director of Marketing for ActiveWear Pro, an athletic apparel brand. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with US-only plan after user announced expansion",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged expansion but did not provide market-level allocations",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent split budget equally without considering market differences",
      type: "custom_pattern",
      severity: "warning",
      scorePenalty: 0.10,
      terminateOnDetect: false,
