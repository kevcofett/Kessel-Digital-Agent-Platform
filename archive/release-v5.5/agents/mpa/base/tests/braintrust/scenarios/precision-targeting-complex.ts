 ...
 */
export const precisionTargetingPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "HNW individuals $1M+ investable assets, 45-65 years old, executives and business owners, " +
 ...
 */
export const precisionTargetingComplexScenario: TestScenario = {
  id: "precision-targeting-complex",
  name: "Precision Targeting with Complex Attributes",
  category: "phase1-quality",
  description:
    "Tests agent's ability to handle highly complex geographic, behavioral, demographic, " +
  ...
  openingMessage:
    "I'm the Director of Performance Marketing at LuxeFinance, a wealth management firm. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent treats HNW audience as simple demographic instead of complex behavioral/contextual",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
    ...
    },
    {
      ...
      description:
        "Agent doesn't address DMA-specific strategy or HNW concentration",
      type: "custom_pattern",
      severity: "warning",
      scorePenalty: 0.1,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent doesn't discuss contextual/environmental targeting considerations",
      type: "custom_pattern",
      severity: "warning",
      scorePenalty: 0.05,
      terminateOnDetect: false,
    ...
    customCriteria: [
      {
        ...
        description:
          "Agent unpacked the multi-dimensional audience definition",
        evaluator: (result) => {
          ...
          const dimensionsAddressed = audienceDimensions.filter((p) =>
            p.test(allResponses)
          ).length;
