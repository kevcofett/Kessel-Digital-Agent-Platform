 ...
 */
export const timelineCompressionPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Fashion-forward women aged 25-45 in urban areas",
    hasGeography: true,
 ...
 */
const timelineCompressionChange: DataChange = {
  triggerTurn: 7,
  field: "timeline",
  oldValue: 12,
  newValue: 6,
  userMessage:
    "I need to tell you something - the board just moved up our launch timeline. " +
 ...
 */
export const timelineCompressionScenario: TestScenario = {
  id: "timeline-compression",
  name: "Timeline Compression",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals compressed timeline. " +
    "Agent MUST recalculate pacing, flag saturation risks, and recommend strategy.",

  persona: timelineCompressionPersona,

  openingMessage:
    "Hi, I'm the VP of Marketing at Urban Essentials, a fashion retail brand. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with 12-month pacing after user announced compression",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent did not recalculate monthly spend or pacing",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent did not discuss pacing risks or saturation challenges",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
...
export const timelineCompressionContext = {
  ...
  kpiAggressiveness: "aggressive" as const, // After timeline compression
