 ...
 */
export const volumeTargetIncreasePersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Homeowners aged 30-55 interested in home décor and furniture",
    hasGeography: true,
 ...
 */
const volumeTargetIncreaseChange: DataChange = {
  triggerTurn: 8,
  field: "volumeTarget",
  oldValue: 5000,
  newValue: 8000,
  userMessage:
    "I just got out of a meeting with leadership. They're pushing for 8,000 customers " +
 ...
 */
export const volumeTargetIncreaseScenario: TestScenario = {
  id: "volume-target-increase",
  name: "Volume Target Increase",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals increased volume targets. " +
    "Agent MUST recalculate efficiency, flag feasibility concerns, and recommend changes.",

  persona: volumeTargetIncreasePersona,

  openingMessage:
    "Hi, I'm the Marketing Manager at HomeStyle Direct. We're an e-commerce company " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with old 5,000 target after user announced increase",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent did not recalculate CAC/efficiency after target increase",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent accepted new target without discussing feasibility",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
...
export const volumeTargetIncreaseContext = {
  ...
  kpiAggressiveness: "aggressive" as const, // After target increase
