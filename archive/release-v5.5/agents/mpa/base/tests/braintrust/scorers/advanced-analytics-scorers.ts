 ...
 */
export function scoreRfmCalculationMethodology(response: string): TurnScore {
  let score = 0;
 ...
 */
export function scoreRfmSegmentQuantification(response: string): TurnScore {
  let score = 0;
  const quantifications: string[] = [];
 ...
 */
export function scorePropensityModelExplanation(response: string): TurnScore {
  let score = 0;
 ...
 */
export function scorePropensityActionMapping(response: string): TurnScore {
  let score = 0;
 ...
 */
export function scoreDecileAnalysisExplanation(response: string): TurnScore {
  let score = 0;
 ...
 */
export function scoreInvestmentCutoffRecommendation(response: string): TurnScore {
  let score = 0;
 ...
 */
export function scoreLookalikeSeedQuality(response: string): TurnScore {
  let score = 0;
  const criteria: string[] = [];
 ...
 */
export function scoreLookalikeExpansionStrategy(response: string): TurnScore {
  let score = 0;
  const elements: string[] = [];
 ...
 */
export function scoreNameFlowMapping(response: string): TurnScore {
  let score = 0;
  const stages: string[] = [];
 ...
 */
export function scoreProfitabilityBasedPlanning(response: string): TurnScore {
  let score = 0;
  const components: string[] = [];
 ...
 */
export function scoreAdvancedAnalytics(response: string): TurnScore {
