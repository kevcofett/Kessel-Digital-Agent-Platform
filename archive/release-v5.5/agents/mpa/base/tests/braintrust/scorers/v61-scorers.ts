 ...
 * @returns TurnScore
 */
export function scoreAutomaticBenchmarkComparison(
  output: string,
  input: string
): TurnScore {
 ...
 * @returns TurnScore
 */
export function scoreDataConfidence(output: string): TurnScore {
 ...
 * @returns TurnScore
 */
export function scorePlatformTaxonomyUsage(
  output: string,
  input: string,
  currentStep: number
): TurnScore {
 ...
 * @returns TurnScore
 */
export function scoreGeographyCensusUsage(
  output: string,
  input: string,
  currentStep: number
): TurnScore {
 ...
 * @returns TurnScore
 */
export function scoreBehavioralContextualUsage(
  output: string,
  input: string,
  currentStep: number
): TurnScore {
