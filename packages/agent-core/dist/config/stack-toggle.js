 ...
 */
import { CLAUDE_STACK_FEATURES, MICROSOFT_STACK_FEATURES, } from './stack-types.js';
    ...
    checkProviderAvailability() {
        return {
            llm: {
                ...
                azureOpenAI: !!(process.env[ENV_VARS.AZURE_OPENAI_ENDPOINT] &&
                    (process.env[ENV_VARS.AZURE_OPENAI_API_KEY] || process.env[ENV_VARS.AZURE_CLIENT_ID])),
                copilotStudio: !!(process.env[ENV_VARS.COPILOT_STUDIO_BOT_ID] &&
            ...
            storage: {
                ...
                dataverse: !!(process.env[ENV_VARS.DATAVERSE_URL] &&
                    process.env[ENV_VARS.AZURE_TENANT_ID] &&
                    process.env[ENV_VARS.AZURE_CLIENT_ID]),
            },
            kb: {
                local: true, // Always available
                sharePoint: !!(process.env[ENV_VARS.SHAREPOINT_SITE_URL] &&
                    process.env[ENV_VARS.AZURE_TENANT_ID]),
 ...
 * Singleton instance
 */
let stackToggleInstance = null;
/**
 * Get the singleton StackToggle instance
 */
export function getStackToggle() {
...
export function isClaudeStack() {
    return getStackToggle().isClaudeStack();
}
export function isMicrosoftStack() {
...
//# sourceMappingURL=stack-toggle.js.map