...
export class AzureAISearchEmbeddingProvider {
    ...
    validateConfig() {
        const missing = [];
        if (!this.endpoint)
            missing.push('AZURE_AI_SEARCH_ENDPOINT');
        if (!this.apiKey)
            missing.push('AZURE_AI_SEARCH_KEY');
        if (missing.length > 0) {
...
//# sourceMappingURL=azure-ai-search-embedding.js.map