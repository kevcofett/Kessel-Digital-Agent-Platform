...
import { EmbeddingProvider, EmbeddingConfig, DEFAULT_EMBEDDING_CONFIG } from './interfaces.js';
...
export class TFIDFEmbeddingProvider implements EmbeddingProvider {
  ...
  constructor(config?: Partial<EmbeddingConfig>) {
    ...
    this.dimension = mergedConfig.maxFeatures;
   ...
   */
  exportState(): { vocabulary: [string, number][]; idf: [string, number][] } {
    return {
   ...
   */
  importState(state: { vocabulary: [string, number][]; idf: [string, number][] }): void {
