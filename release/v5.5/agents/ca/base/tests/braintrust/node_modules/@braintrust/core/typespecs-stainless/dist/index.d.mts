...
declare const objectTypes: z.ZodEnum<["project", "experiment", "dataset", "prompt", "prompt_session", "role", "group", "acl", "user", "project_score", "project_tag", "function", "view", "organization"]>;
...
declare function getEventObjectType(objectType: ObjectTypeWithEvent): "function" | "experiment" | "dataset" | "prompt" | "prompt_session" | "project_logs";
...
declare const orgSecretsSchema: z.ZodObject<{
    id: z.ZodString;
    created: z.ZodOptional<z.ZodNullable<z.ZodEffects<z.ZodString, string, string>>>;
    key_id: z.ZodString;
    org_id: z.ZodString;
...
type OrgSecrets = z.infer<typeof orgSecretsSchema>;
...
declare const codeBundleSchema: z.ZodObject<{
    ...
    location: z.ZodObject<{
        ...
        position: z.ZodUnion<[z.ZodLiteral<"task">, z.ZodObject<{
            score: z.ZodNumber;
        }, "strip", z.ZodTypeAny, {
            score: number;
        }, {
...
declare const projectScoreTypeEnum: z.ZodEnum<["slider", "categorical", "weighted", "minimum"]>;
...
declare const projectScoreSchema: z.ZodObject<{
    ...
    name: z.ZodString;
    description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    score_type: z.ZodEnum<["slider", "categorical", "weighted", "minimum"]>;
    ...
    project_id: string;
    user_id: string;
    score_type: "minimum" | "slider" | "categorical" | "weighted";
    created?: string | null | undefined;
    description?: string | null | undefined;
...
declare const viewSchema: z.ZodObject<{
    ...
    view_data: z.ZodOptional<z.ZodNullable<z.ZodObject<{
        search: z.ZodOptional<z.ZodNullable<z.ZodObject<{
            filter: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodAny, "many">>>;
            tag: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodAny, "many">>>;
            match: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodAny, "many">>>;
            sort: z.ZodOptional<z.ZodNullable<z.ZodArray<z.ZodAny, "many">>>;
        }, "strip", z.ZodTypeAny, {
            filter?: any[] | null | undefined;
            tag?: any[] | null | undefined;
            match?: any[] | null | undefined;
...
declare const patchExperimentSchema: z.ZodObject<Omit<{
    project_id: z.ZodString;
    name: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    repo_info: z.ZodOptional<z.ZodNullable<z.ZodObject<{
...
}, "project_id" | "ensure_new">, "strip", z.ZodTypeAny, {
    description?: string | null | undefined;
    name?: string | null | undefined;
    metadata?: Record<string, any> | null | undefined;
    repo_info?: {
...
declare const createAclSchema: z.ZodObject<Omit<{
    id: z.ZodString;
    object_type: z.ZodEnum<["organization", "project", "experiment", "dataset", "prompt", "prompt_session", "group", "role", "org_member", "project_log", "org_project"]>;
    object_id: z.ZodString;
    user_id: z.ZodOptional<z.ZodNullable<z.ZodString>>;
...
declare const patchProjectScoreSchema: z.ZodObject<{
    name: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    description: z.ZodOptional<z.ZodNullable<z.ZodString>>;
    score_type: z.ZodOptional<z.ZodNullable<z.ZodEnum<["slider", "categorical", "weighted", "minimum"]>>>;
    categories: z.ZodOptional<z.ZodNullable<z.ZodUnion<[z.ZodArray<z.ZodObject<{
        name: z.ZodString;
        value: z.ZodNumber;
    }, "strip", z.ZodTypeAny, {
    ...
    name?: string | null | undefined;
    description?: string | null | undefined;
    score_type?: "minimum" | "slider" | "categorical" | "weighted" | null | undefined;
    categories?: string[] | Record<string, number> | {
        value: number;
        name: string;
    }[] | null | undefined;
...
declare const INVOKE_API_VERSION = 1;
...
declare const useFunctionSchema: z.ZodIntersection<z.ZodObject<{
    api_version: z.ZodDefault<z.ZodOptional<z.ZodNumber>>;
}, "strip", z.ZodTypeAny, {
    api_version: number;
}, {
...
declare const invokeFunctionSchema: z.ZodIntersection<z.ZodIntersection<z.ZodObject<{
    api_version: z.ZodDefault<z.ZodOptional<z.ZodNumber>>;
}, "strip", z.ZodTypeAny, {
    api_version: number;
}, {
...
declare function getFunctionId<T extends FunctionId>(functionId: T): FunctionId;
...
export { type Acl, type AclObjectType, type AnyModelParam, type ApiKey, BRAINTRUST_PARAMS, type CallEventSchema, type CodeBundle, type Content, type ContentPart, type ContentPartImage, type ContentPartText, type Dataset, type DatasetEvent, type EventObjectSchemasEntry, type EventObjectType, type Experiment, type ExperimentEvent, type FunctionId, type FunctionObject, type Group, INVOKE_API_VERSION, type InvokeFunctionRequest, type Json, type MaxOverWindow, type Member, type Message, type MessageRole, type ModelParams, type ObjectSchemasEntry, type ObjectType, type ObjectTypeWithEvent, type OpenAIMessage, type OpenAIModelParams, type OrgSecrets, type Organization, type Permission, type Project, type ProjectLogsEvent, type ProjectScore, type ProjectScoreCategory, type ProjectScoreType, type ProjectSettings, type ProjectTag, type Prompt, type PromptBlockData, type PromptData, type PromptOptions, type PromptSession, type PromptSessionEvent, type Resources, type Role, type Runtime, type RuntimeContext, type ToolCall, type Tools, type User, type View, type ViewData, type ViewOptions, type ViewType, aclObjectTypeEnum, aclSchema, allFetchFiltersSchema, apiKeySchema, apiSpecEventObjectSchemas, apiSpecObjectSchemas, appLimitSchema, auditSourcesSchema, baseSSEEventSchema, callEventSchema, chatCompletionContentPartImageSchema, chatCompletionMessageToolCallSchema, codeBundleSchema, comparisonExperimentIdParamSchema, createAclSchema, createViewSchema, crossObjectInsertRequestSchema, crossObjectInsertResponseSchema, customTypes, customTypesMode, datasetEventSchema, datasetSchema, datetimeStringSchema, endingBeforeSchema, experimentEventSchema, experimentSchema, fetchEventsRequestSchema, fetchFiltersSchema, fetchLimitSchema, fetchPaginationCursorSchema, functionDataSchema, functionIdSchema, functionSchema, getEventObjectDescription, getEventObjectType, getFunctionId, getObjectArticle, groupSchema, insertEventsResponseSchema, invokeFunctionSchema, jsonSchema, literalSchema, makeObjectIdsFilterSchema, maxOverWindowSchema, maxRootSpanIdSchema, maxXactIdSchema, memberSchema, messageRoleSchema, modelParamsSchema, objectTypeSummarizeResponseSchemas, objectTypes, objectTypesWithEvent, orgSecretsSchema, organizationSchema, patchDatasetSchema, patchExperimentSchema, patchGroupSchema, patchOrganizationSchema, patchProjectSchema, patchProjectScoreSchema, patchProjectTagSchema, patchRoleSchema, patchViewSchema, permissionEnum, projectLogsEventSchema, projectSchema, projectScoreCategory, projectScoreSchema, projectScoreTypeEnum, projectSettingsSchema, projectTagSchema, promptBaseSchema, promptBlockDataSchema, promptDataSchema, promptOptionsSchema, promptSchema, promptSessionEventSchema, promptSessionSchema, repoInfoSchema, resourcesSchema, roleSchema, runtimeContextSchema, sseDataEventSchema, sseDoneEventSchema, sseTextEventSchema, startingAfterSchema, summarizeDataParamSchema, summarizeScoresParamSchema, toolsSchema, useFunctionSchema, userSchema, validRuntimesEnum, versionSchema, viewDataSchema, viewDataSearchSchema, viewOptionsSchema, viewSchema, viewTypeEnum };
