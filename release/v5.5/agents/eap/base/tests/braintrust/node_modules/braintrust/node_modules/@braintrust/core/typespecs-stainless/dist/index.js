...
var messageRoleSchema = import_zod4.z.enum([
  "system",
  "user",
  "assistant",
  "function",
...
var openAIModelParamsSchema = import_zod7.z.object({
  ...
  response_format: import_zod7.z.object({ type: import_zod7.z.literal("json_object") }).nullish(),
...
var jsCompletionParamsSchema = import_zod7.z.object({});
...
var validRuntimesEnum = import_zod9.z.enum(["node", "python"]);
var functionTypeEnum = import_zod9.z.enum(["llm", "scorer", "task", "tool"]);
var runtimeContextSchema = import_zod9.z.object({
  runtime: validRuntimesEnum,
  version: import_zod9.z.string()
});
var functionIdSchema = import_zod9.z.union([
  import_zod9.z.object({
    function_id: import_zod9.z.string().describe("The ID of the function"),
    version: import_zod9.z.string().optional().describe("The version of the function")
  }).describe("Function id"),
  import_zod9.z.object({
    project_name: import_zod9.z.string().describe("The name of the project containing the function"),
    slug: import_zod9.z.string().describe("The slug of the function"),
    version: import_zod9.z.string().optional().describe("The version of the function")
  }).describe("Project name and slug"),
  import_zod9.z.object({
    global_function: import_zod9.z.string().describe(
  ...
  import_zod9.z.object({
    prompt_session_id: import_zod9.z.string().describe("The ID of the prompt session"),
    prompt_session_function_id: import_zod9.z.string().describe("The ID of the function in the prompt session"),
    version: import_zod9.z.string().optional().describe("The version of the function")
  }).describe("Prompt session id"),
  import_zod9.z.object({
    inline_context: runtimeContextSchema,
    code: import_zod9.z.string().describe("The inline code to execute"),
    name: import_zod9.z.string().nullish().describe("The name of the inline code function")
  }).describe("Inline code function"),
  import_zod9.z.object({
    inline_prompt: promptDataSchema,
    name: import_zod9.z.string().nullish().describe("The name of the inline prompt")
  }).describe("Inline prompt definition")
]).describe("Options for identifying a function");
var useFunctionSchema = functionIdSchema;
var streamingModeEnum = import_zod9.z.enum(["auto", "parallel"]);
var invokeFunctionNonIdArgsSchema = import_zod9.z.object({
  input: customTypes.unknown.optional().describe(
    "Argument to the function, which can be any JSON serializable value"
  ),
  messages: import_zod9.z.array(chatCompletionMessageParamSchema).optional().describe(
    "If the function is an LLM, additional messages to pass along to it"
  ),
  parent: import_zod9.z.union([
    import_zod9.z.object({
      object_type: import_zod9.z.enum(["project_logs", "experiment"]),
      object_id: import_zod9.z.string().describe("The id of the container object you are logging to"),
      row_ids: import_zod9.z.object({
        id: import_zod9.z.string().describe("The id of the row"),
        span_id: import_zod9.z.string().describe("The span_id of the row"),
        root_span_id: import_zod9.z.string().describe("The root_span_id of the row")
      }).nullish().describe("Identifiers for the row to to log a subspan under"),
      propagated_event: import_zod9.z.record(customTypes.unknown).nullish().describe(
        "Include these properties in every span created under this parent"
      )
    }).describe("Span parent properties").openapi({ title: "span_parent_struct" }),
    import_zod9.z.string().optional().describe(
      "The parent's span identifier, created by calling `.export()` on a span"
    )
  ]).describe("Options for tracing the function call"),
  stream: import_zod9.z.boolean().nullish().describe(
...
var runEvalSchema = import_zod9.z.object({
  project_id: import_zod9.z.string().describe("Unique identifier for the project to run the eval in"),
  data: import_zod9.z.union([
    import_zod9.z.object({
      dataset_id: import_zod9.z.string()
    }).describe("Dataset id"),
    import_zod9.z.object({
      project_name: import_zod9.z.string(),
      dataset_name: import_zod9.z.string()
    }).describe("Project and dataset name")
  ]).describe("The dataset to use"),
  task: functionIdSchema.describe("The function to evaluate"),
  scores: import_zod9.z.array(functionIdSchema).describe("The functions to score the eval on"),
  experiment_name: import_zod9.z.string().optional().describe(
...
var baseSSEEventSchema = import_zod9.z.object({
  id: import_zod9.z.string().optional(),
  data: import_zod9.z.string()
});
var sseTextEventSchema = baseSSEEventSchema.merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("text_delta")
  })
);
var sseDataEventSchema = baseSSEEventSchema.merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("json_delta")
  })
);
var sseErrorEventSchema = baseSSEEventSchema.merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("error")
  })
);
var sseProgressEventSchema = baseSSEEventSchema.merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("progress")
  })
);
var sseStartEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("start"),
    data: import_zod9.z.literal("")
  })
);
var sseDoneEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod9.z.object({
    event: import_zod9.z.literal("done"),
    data: import_zod9.z.literal("")
  })
);
var functionObjectTypeEnum = import_zod9.z.enum([
  "prompt",
  "tool",
  "scorer",
  "task"
]);
var functionFormatEnum = import_zod9.z.enum(["llm", "code", "global"]);
var functionOutputTypeEnum = import_zod9.z.enum(["completion", "score", "any"]);
var sseProgressEventDataSchema = import_zod9.z.object({
  id: import_zod9.z.string().describe("The id of the span this event is for"),
  object_type: functionObjectTypeEnum,
  format: functionFormatEnum,
  output_type: functionOutputTypeEnum,
  name: import_zod9.z.string(),
  event: import_zod9.z.enum(["text_delta", "json_delta", "error", "start", "done"]),
  data: import_zod9.z.string()
  // This is the text_delta or json_delta
});
var callEventSchema = import_zod9.z.union([
...
var scoreSchema = import_zod9.z.union([
  import_zod9.z.object({
    name: import_zod9.z.string(),
    score: import_zod9.z.number().min(0).max(1).nullable().default(null),
    // Sometimes we get an empty value over the wire
    metadata: import_zod9.z.record(customTypes.unknown).optional().transform((data) => data != null ? data : void 0)
  }),
  import_zod9.z.number().min(0).max(1),
  import_zod9.z.boolean().transform((b) => b ? 1 : 0),
  import_zod9.z.null()
]);
var ifExistsEnum = import_zod9.z.enum(["error", "ignore", "replace"]);
...
function generateBaseTableSchema(objectName, opts) {
  ...
  return import_zod10.z.object({
    id: import_zod10.z.string().uuid().describe(`Unique identifier for the ${objectName}`),
    project_id: import_zod10.z.string().uuid().describe(
      `Unique identifier for the project that the ${objectName} belongs under`
    ),
    name: import_zod10.z.string().describe(nameDescription),
    description: import_zod10.z.string().nullish().describe(`Textual description of the ${objectName}`),
    ...
    user_id: import_zod10.z.string().uuid().nullish().describe(`Identifies the user who created the ${objectName}`),
    metadata: import_zod10.z.record(customTypes.unknown).nullish().describe(`User-controlled metadata about the ${objectName}`)
  });
}
var aclObjectTypeEnum = import_zod10.z.enum([
  "organization",
  "project",
  "experiment",
  "dataset",
...
var userSchema = import_zod10.z.object({
  ...
  given_name: import_zod10.z.string().nullish().describe("Given name of the user"),
  family_name: import_zod10.z.string().nullish().describe("Family name of the user"),
  email: import_zod10.z.string().nullish().describe("The user's email"),
  avatar_url: import_zod10.z.string().nullish().describe("URL of the user's Avatar image"),
  created: userBaseSchema.shape.created
}).openapi("User");
var organizationBaseSchema = generateBaseTableSchema("organization");
var organizationSchema = import_zod10.z.object({
  id: organizationBaseSchema.shape.id,
  name: organizationBaseSchema.shape.name,
  api_url: import_zod10.z.string().nullish(),
  is_universal_api: import_zod10.z.boolean().nullish(),
  proxy_url: import_zod10.z.string().nullish(),
  realtime_url: import_zod10.z.string().nullish(),
  created: organizationBaseSchema.shape.created
}).openapi("Organization");
var maxOverWindowSchema = import_zod10.z.object({
  window_size_days: import_zod10.z.number().int().positive(),
  max_value: import_zod10.z.number().nonnegative()
}).openapi("MaxOverWindow");
var resourcesSchema = import_zod10.z.object({
  org_id: organizationSchema.shape.id,
  forbid_toggle_experiment_public_to_private: import_zod10.z.boolean().nullish(),
  num_private_experiment_row_actions: maxOverWindowSchema.nullish(),
  forbid_insert_datasets: import_zod10.z.boolean().nullish(),
  forbid_insert_prompt_sessions: import_zod10.z.boolean().nullish(),
  forbid_access_sql_explorer: import_zod10.z.boolean().nullish(),
  num_production_log_row_actions: maxOverWindowSchema.nullish(),
  num_dataset_row_actions: maxOverWindowSchema.nullish()
}).openapi("Resources");
var memberSchema = import_zod10.z.object({
  org_id: organizationSchema.shape.id,
  user_id: userSchema.shape.id
}).openapi("Member");
var aiSecretBaseSchema = generateBaseTableSchema("AI secret");
var aiSecretSchema = import_zod10.z.object({
  id: aiSecretBaseSchema.shape.id,
  created: aiSecretBaseSchema.shape.created,
  org_id: organizationSchema.shape.id,
  name: aiSecretBaseSchema.shape.name,
  type: import_zod10.z.string().nullish(),
  metadata: import_zod10.z.record(customTypes.unknown).nullish(),
  preview_secret: import_zod10.z.string().nullish()
}).openapi("AISecret");
var envVarObjectTypeEnum = import_zod10.z.enum(["organization", "project", "function"]).describe("The type of the object the environment variable is scoped for");
var envVarBaseSchema = generateBaseTableSchema("environment variable");
var envVarSchema = import_zod10.z.object({
  id: envVarBaseSchema.shape.id,
  object_type: envVarObjectTypeEnum,
  object_id: import_zod10.z.string().uuid().describe("The id of the object the environment variable is scoped for"),
  name: import_zod10.z.string().describe("The name of the environment variable"),
...
var apiKeySchema = import_zod10.z.object({
  ...
  preview_name: import_zod10.z.string(),
...
var projectSettingsSchema = import_zod10.z.object({
  comparison_key: import_zod10.z.string().nullish().describe("The key used to join two experiments (defaults to `input`).")
});
var projectBaseSchema = generateBaseTableSchema("project");
var projectSchema = import_zod10.z.object({
  id: projectBaseSchema.shape.id,
  org_id: import_zod10.z.string().uuid().describe(
...
var datasetSchema = import_zod10.z.object({
...
var promptLogIdLiteralSchema = import_zod10.z.literal("p").describe("A literal 'p' which identifies the object as a project prompt");
var promptBaseSchema = generateBaseTableSchema("prompt");
var promptSchemaObject = import_zod10.z.object({
  id: promptBaseSchema.shape.id,
  // This has to be copy/pasted because zod blows up when there are circular dependencies
  _xact_id: import_zod10.z.string().describe(
  ...
  slug: import_zod10.z.string().describe("Unique identifier for the prompt"),
  ...
  tags: import_zod10.z.array(import_zod10.z.string()).nullish().describe("A list of tags for the prompt"),
...
var functionSchema2 = promptSchemaObject.merge(
  import_zod10.z.object({
    ...
    origin: import_zod10.z.object({
      ...
      object_id: import_zod10.z.string().uuid().describe("Id of the object the function is originating from"),
      internal: import_zod10.z.boolean().nullish().describe(
        "The function exists for internal purposes and should not be displayed in the list of functions."
      )
    }).nullish(),
    function_schema: import_zod10.z.object({
...
var repoInfoSchema = import_zod10.z.object({
  commit: import_zod10.z.string().nullish().describe("SHA of most recent commit"),
  branch: import_zod10.z.string().nullish().describe("Name of the branch the most recent commit belongs to"),
  tag: import_zod10.z.string().nullish().describe("Name of the tag on the most recent commit"),
  dirty: import_zod10.z.boolean().nullish().describe(
    "Whether or not the repo had uncommitted changes when snapshotted"
  ),
  author_name: import_zod10.z.string().nullish().describe("Name of the author of the most recent commit"),
  author_email: import_zod10.z.string().nullish().describe("Email of the author of the most recent commit"),
  commit_message: import_zod10.z.string().nullish().describe("Most recent commit message"),
  commit_time: import_zod10.z.string().nullish().describe("Time of the most recent commit"),
  git_diff: import_zod10.z.string().nullish().describe(
...
var experimentSchema = import_zod10.z.object({
  ...
  commit: import_zod10.z.string().nullish().describe("Commit, taken directly from `repo_info.commit`"),
  base_exp_id: import_zod10.z.string().uuid().nullish().describe(
    "Id of default base experiment to compare against when viewing this experiment"
  ),
  deleted_at: experimentBaseSchema.shape.deleted_at,
  dataset_id: import_zod10.z.string().uuid().nullish().describe(
    "Identifier of the linked dataset, or null if the experiment is not linked to a dataset"
  ),
  dataset_version: import_zod10.z.string().nullish().describe(
    "Version number of the linked dataset the experiment was run against. This can be used to reproduce the experiment after the dataset has been modified."
  ),
  public: import_zod10.z.boolean().describe(
...
var promptSessionSchema = import_zod10.z.object({
...
var permissionEnum = import_zod10.z.enum([
  "create",
  "read",
  "update",
  "delete",
...
var roleSchema = import_zod10.z.object({
  id: roleBaseSchema.shape.id,
  org_id: import_zod10.z.string().uuid().nullish().describe(
    [
  ...
  member_permissions: import_zod10.z.array(
    import_zod10.z.object({
  ...
  member_roles: import_zod10.z.array(import_zod10.z.string().uuid()).nullish().describe(
    [
...
var groupSchema = import_zod10.z.object({
  ...
  member_users: import_zod10.z.array(import_zod10.z.string().uuid()).nullish().describe("Ids of users which belong to this group"),
  member_groups: import_zod10.z.array(import_zod10.z.string().uuid()).nullish().describe(
    [
...
var projectScoreTypeEnum = import_zod10.z.enum(["slider", "categorical", "weighted", "minimum", "online"]).describe("The type of the configured score");
var projectScoreCategory = import_zod10.z.object({
  name: import_zod10.z.string().describe("Name of the category"),
  value: import_zod10.z.number().describe(
    "Numerical value of the category. Must be between 0 and 1, inclusive"
  )
}).describe("For categorical-type project scores, defines a single category").openapi("ProjectScoreCategory");
var onlineScoreConfigSchema = import_zod10.z.object({
  sampling_rate: import_zod10.z.number().min(0).max(1).describe("The sampling rate for online scoring"),
  scorers: import_zod10.z.array(savedFunctionIdSchema).describe("The list of scorers to use for online scoring"),
  apply_to_root_span: import_zod10.z.boolean().nullish().describe(
    "Whether to trigger online scoring on the root span of each trace"
  ),
  apply_to_span_names: import_zod10.z.string().array().nullish().describe("Trigger online scoring on any spans with a name in this list")
}).refine((val) => {
  var _a;
...
var projectScoreSchema = import_zod10.z.object({
  ...
  categories: import_zod10.z.union([
    projectScoreCategory.array().describe(
      "For categorical-type project scores, the list of all categories"
    ).openapi({ title: "categorical" }),
    import_zod10.z.record(import_zod10.z.number()).describe(
      "For weighted-type project scores, the weights of each score"
    ).openapi({ title: "weighted" }),
    import_zod10.z.array(import_zod10.z.string()).describe(
      "For minimum-type project scores, the list of included scores"
    ).openapi({ title: "minimum" })
  ]).nullish().openapi("ProjectScoreCategories"),
  config: import_zod10.z.object({
    multi_select: import_zod10.z.boolean().nullish(),
    destination: import_zod10.z.literal("expected").nullish(),
    online: onlineScoreConfigSchema.nullish()
  }).nullish().openapi("ProjectScoreConfig"),
  position: import_zod10.z.string().nullish().describe(
...
var projectTagSchema = import_zod10.z.object({
  ...
  color: import_zod10.z.string().nullish().describe("Color of the tag for the UI")
}).describe(
...
var viewSchema = import_zod10.z.object({
  id: viewBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod10.z.string().uuid().describe("The id of the object the view applies to"),
...
var aclSchema = import_zod10.z.object({
  id: aclBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod10.z.string().uuid().describe("The id of the object the ACL applies to"),
  user_id: import_zod10.z.string().uuid().nullish().describe(
    "Id of the user the ACL applies to. Exactly one of `user_id` and `group_id` will be provided"
  ),
  group_id: import_zod10.z.string().uuid().nullish().describe(
  ...
  role_id: import_zod10.z.string().uuid().nullish().describe(
    "Id of the role the ACL grants. Exactly one of `permission` and `role_id` will be provided"
  ),
  _object_org_id: import_zod10.z.string().uuid().describe("The organization the ACL's referred object belongs to"),
...
var appLimitSchema = import_zod10.z.number().int().nonnegative().describe("Limit the number of objects to return");
function generateBaseTableOpSchema(objectName) {
  return import_zod10.z.object({
    org_name: import_zod10.z.string().nullish().describe(
...
var startingAfterSchema = import_zod10.z.string().uuid().describe(
  [
    "Pagination cursor id.",
    "For example, if the final item in the last page you fetched had an id of `foo`, pass `starting_after=foo` to fetch the next page. Note: you may only pass one of `starting_after` and `ending_before`"
  ].join("\n\n")
).openapi("StartingAfter");
var endingBeforeSchema = import_zod10.z.string().uuid().describe(
  [
    "Pagination cursor id.",
...
function makeObjectIdsFilterSchema(objectName) {
  const item = import_zod10.z.string().uuid();
  return import_zod10.z.union([item, item.array()]).describe(
...
var createProjectSchema = import_zod10.z.object({
  name: projectSchema.shape.name,
  org_name: createProjectBaseSchema.shape.org_name
}).openapi("CreateProject");
var patchProjectSchema = import_zod10.z.object({
...
var createExperimentSchema = import_zod10.z.object({
  ...
  ensure_new: import_zod10.z.boolean().nullish().describe(
...
var createDatasetSchema = import_zod10.z.object({
...
var patchDatasetSchema = import_zod10.z.object({
...
var patchPromptSchema = import_zod10.z.object({
...
var patchFunctionSchema = import_zod10.z.object({
...
var createRoleSchema = import_zod10.z.object({
...
var createGroupSchema = import_zod10.z.object({
...
var aclBatchUpdateRequestSchema = import_zod10.z.object({
  add_acls: aclItemSchema.array().nullish(),
  remove_acls: aclItemSchema.array().nullish()
});
var aclBatchUpdateResponseSchema = import_zod10.z.object({
...
var createProjectTagSchema = import_zod10.z.object({
...
var patchProjectTagSchema = import_zod10.z.object({
...
var patchViewSchema = import_zod10.z.object({
...
var deleteViewSchema = import_zod10.z.object({
  object_type: viewSchema.shape.object_type,
  object_id: viewSchema.shape.object_id
}).openapi("DeleteView");
var patchOrganizationSchema = import_zod10.z.object({
...
var createApiKeySchema = import_zod10.z.object({
  name: import_zod10.z.string().describe("Name of the api key. Does not have to be unique"),
  org_name: createApiKeyBaseSchema.shape.org_name
});
var createApiKeyOutputSchema = apiKeySchema.merge(
  import_zod10.z.object({
    key: import_zod10.z.string().describe("The raw API key. It will only be exposed this one time")
  })
).openapi("CreateApiKeyOutput");
var organizationMembersSchema = import_zod10.z.object({
  members: userSchema.pick({ id: true, email: true }).array()
}).openapi("OrganizationMembers");
var patchOrganizationMembersSchema = import_zod10.z.object({
  invite_users: import_zod10.z.object({
    ...
    send_invite_emails: import_zod10.z.boolean().nullish().describe(
  ...
  remove_users: import_zod10.z.object({
  ...
  org_id: import_zod10.z.string().nullish().describe(
...
var patchOrganizationMembersOutputSchema = import_zod10.z.object({
  status: import_zod10.z.literal("success"),
  send_email_error: import_zod10.z.string().nullish().describe(
...
var deleteAISecretSchema = import_zod10.z.object({
  name: aiSecretSchema.shape.name,
  org_name: createAISecretBaseSchema.shape.org_name
});
var patchAISecretSchema = import_zod10.z.object({
  name: aiSecretSchema.shape.name.nullish(),
  type: aiSecretSchema.shape.type,
  metadata: aiSecretSchema.shape.metadata,
  secret: import_zod10.z.string().nullish()
});
var createEnvVarSchema = envVarSchema.pick({ object_type: true, object_id: true, name: true }).extend({
  value: import_zod10.z.string().nullish().describe(
...
var auditSourcesSchema = import_zod11.z.enum(VALID_SOURCES);
function generateBaseEventOpSchema(objectType) {
  ...
  return import_zod11.z.object({
    ...
    [TRANSACTION_ID_FIELD]: import_zod11.z.string().describe(
    ...
    tags: import_zod11.z.array(import_zod11.z.string()).nullish().describe("A list of tags to log"),
    scores: import_zod11.z.record(import_zod11.z.number().min(0).max(1).nullish()).nullish(),
    metadata: import_zod11.z.record(customTypes.unknown).nullish().describe(
      "A dictionary with additional data about the test example, model outputs, or just about anything else that's relevant, that you can use to help find and analyze examples later. For example, you could log the `prompt`, example's `id`, or anything else that would be useful to slice/dice later. The values in `metadata` can be any JSON-serializable type, but its keys must be strings"
    ),
    metrics: import_zod11.z.object({
      start: import_zod11.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event started`
      ),
      end: import_zod11.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event finished`
      ),
      prompt_tokens: import_zod11.z.number().int().nullish().describe(
        `The number of tokens in the prompt used to generate the ${eventDescription} event (only set if this is an LLM span)`
      ),
      completion_tokens: import_zod11.z.number().int().nullish().describe(
        `The number of tokens in the completion generated by the model (only set if this is an LLM span)`
      ),
      tokens: import_zod11.z.number().int().nullish().describe(
    ...
    context: import_zod11.z.object({
      caller_functionname: import_zod11.z.string().nullish().describe(
        `The function in code which created the ${eventDescription} event`
      ),
      caller_filename: import_zod11.z.string().nullish().describe(
        `Name of the file in code where the ${eventDescription} event was created`
      ),
      caller_lineno: import_zod11.z.number().int().nullish().describe(
    ...
    span_id: import_zod11.z.string().describe(
    ...
    span_parents: import_zod11.z.string().array().nullish().describe(
    ...
    root_span_id: import_zod11.z.string().describe(
      `The \`span_id\` of the root of the trace this ${eventDescription} event belongs to`
    ),
    span_attributes: import_zod11.z.object({
      name: import_zod11.z.string().nullish().describe("Name of the span, for display purposes only"),
      type: import_zod11.z.enum(spanTypeAttributeValues).nullish().describe("Type of the span, for display purposes only")
    }).catchall(customTypes.unknown).nullish().describe(
      "Human-identifying attributes of the span, such as name, type, etc."
    ),
    [OBJECT_DELETE_FIELD]: import_zod11.z.boolean().nullish().describe(
...
function generateBaseEventFeedbackSchema(objectType) {
  ...
  return import_zod11.z.object({
    ...
    scores: import_zod11.z.record(import_zod11.z.number().min(0).max(1).nullish()).nullish().describe(
    ...
    tags: import_zod11.z.array(import_zod11.z.string()).nullish().describe("A list of tags to log"),
    comment: import_zod11.z.string().nullish().describe(
...
var fetchLimitSchema = import_zod11.z.number().int().nonnegative().describe(
  [
...
var maxXactIdSchema = import_zod11.z.string().describe(fetchPaginationCursorDescription);
var maxRootSpanIdSchema = import_zod11.z.string().describe(fetchPaginationCursorDescription);
var fetchPaginationCursorSchema = import_zod11.z.string().describe(
  [
...
var versionSchema = import_zod11.z.string().describe(
  [
...
var pathTypeFilterSchema = import_zod11.z.object({
  type: import_zod11.z.literal("path_lookup").describe("Denotes the type of filter as a path-lookup filter"),
  path: import_zod11.z.string().array().describe(
...
var fetchEventsRequestSchema = import_zod11.z.object({
...
function makeFetchEventsResponseSchema(objectType, eventSchema) {
  ...
  return import_zod11.z.object({
    ...
    cursor: import_zod11.z.string().nullish().describe(
      [
        "Pagination cursor",
...
var experimentEventSchema = import_zod11.z.object({
  id: experimentEventBaseSchema.shape.id,
  dataset_record_id: import_zod11.z.string().nullish().describe(
...
var datasetEventSchema = import_zod11.z.object({
...
var promptSessionEventSchema = import_zod11.z.object({
...
var projectLogsLogIdLiteralSchema = import_zod11.z.literal("g").describe("A literal 'g' which identifies the log as a project log");
var projectLogsEventSchema = import_zod11.z.object({
...
var mergeEventSchema = import_zod11.z.object({
  [IS_MERGE_FIELD]: customTypes.literalTrue.describe(isMergeDescription),
  [MERGE_PATHS_FIELD]: import_zod11.z.string().array().array().nullish().describe(
    [
...
var replacementEventSchema = import_zod11.z.object({
  [IS_MERGE_FIELD]: customTypes.literalFalse.nullish().describe(isMergeDescription),
  [PARENT_ID_FIELD]: import_zod11.z.string().nullish().describe(
    [
...
function makeInsertEventSchemas(objectType, insertSchema) {
  ...
  const eventSchema = import_zod11.z.union([replaceVariantSchema, mergeVariantSchema]).describe(`${capitalize(article)} ${eventDescription} event`).openapi(`Insert${eventSchemaName}Event`);
  const requestSchema = import_zod11.z.object({
...
var insertEventsResponseSchema = import_zod11.z.object({
  row_ids: import_zod11.z.string().array().describe(
    "The ids of all rows that were inserted, aligning one-to-one with the rows provided as input"
  )
}).openapi("InsertEventsResponse");
var feedbackResponseSchema = import_zod11.z.object({
...
function makeCrossObjectIndividualRequestSchema(objectType) {
  ...
  const insertObject = import_zod11.z.object({
  ...
  return import_zod11.z.record(import_zod11.z.string().uuid(), insertObject).nullish().describe(
...
function makeCrossObjectIndividualResponseSchema(objectType) {
  return import_zod11.z.record(import_zod11.z.string().uuid(), insertEventsResponseSchema).nullish().describe(
    `A mapping from ${objectType} id to row ids for inserted \`events\``
  );
}
var crossObjectInsertRequestSchema = import_zod11.z.object({
...
var crossObjectInsertResponseSchema = import_zod11.z.object({
...
var summarizeScoresParamSchema = import_zod11.z.boolean().describe(
  "Whether to summarize the scores and metrics. If false (or omitted), only the metadata will be returned."
);
var comparisonExperimentIdParamSchema = import_zod11.z.string().uuid().describe(
...
var summarizeDataParamSchema = import_zod11.z.boolean().describe(
  "Whether to summarize the data. If false (or omitted), only the metadata will be returned."
);
var summarizeExperimentResponseSchema = import_zod11.z.object({
  project_name: import_zod11.z.string().describe("Name of the project that the experiment belongs to"),
  experiment_name: import_zod11.z.string().describe("Name of the experiment"),
  project_url: import_zod11.z.string().url().describe("URL to the project's page in the Braintrust app"),
  experiment_url: import_zod11.z.string().url().describe("URL to the experiment's page in the Braintrust app"),
  comparison_experiment_name: import_zod11.z.string().nullish().describe("The experiment which scores are baselined against"),
  scores: import_zod11.z.record(
    import_zod11.z.object({
      name: import_zod11.z.string().describe("Name of the score"),
      score: import_zod11.z.number().min(0).max(1).describe("Average score across all examples"),
      diff: import_zod11.z.number().min(-1).max(1).optional().describe(
        "Difference in score between the current and comparison experiment"
      ),
      improvements: import_zod11.z.number().int().min(0).describe("Number of improvements in the score"),
      regressions: import_zod11.z.number().int().min(0).describe("Number of regressions in the score")
    }).describe("Summary of a score's performance").openapi("ScoreSummary")
  ).nullish().describe("Summary of the experiment's scores"),
  metrics: import_zod11.z.record(
    import_zod11.z.object({
      name: import_zod11.z.string().describe("Name of the metric"),
      metric: import_zod11.z.number().describe("Average metric across all examples"),
      unit: import_zod11.z.string().describe("Unit label for the metric"),
      diff: import_zod11.z.number().optional().describe(
        "Difference in metric between the current and comparison experiment"
      ),
      improvements: import_zod11.z.number().int().min(0).describe("Number of improvements in the metric"),
      regressions: import_zod11.z.number().int().min(0).describe("Number of regressions in the metric")
...
var summarizeDatasetResponseSchema = import_zod11.z.object({
  project_name: import_zod11.z.string().describe("Name of the project that the dataset belongs to"),
  dataset_name: import_zod11.z.string().describe("Name of the dataset"),
  project_url: import_zod11.z.string().url().describe("URL to the project's page in the Braintrust app"),
  dataset_url: import_zod11.z.string().url().describe("URL to the dataset's page in the Braintrust app"),
  data_summary: import_zod11.z.object({
    total_records: import_zod11.z.number().int().min(0).describe("Total number of records in the dataset")
...
var asyncScoringStateSchema = import_zod11.z.union([
  import_zod11.z.object({
    status: import_zod11.z.literal("enabled"),
    token: import_zod11.z.string(),
    function_ids: import_zod11.z.array(functionIdSchema).nonempty()
  }),
  // Explicitly disabled.
  import_zod11.z.object({
    status: import_zod11.z.literal("disabled")
  }),
  // Inactive but may be selected later.
  import_zod11.z.null()
]);
var asyncScoringControlSchema = import_zod11.z.discriminatedUnion("kind", [
  import_zod11.z.object({
    kind: import_zod11.z.literal("score_update"),
    token: import_zod11.z.string()
  }),
  import_zod11.z.object({
    kind: import_zod11.z.literal("state_override"),
    state: asyncScoringStateSchema
  }),
  import_zod11.z.object({
    kind: import_zod11.z.literal("state_force_reselect")
  })
]);
