...
// USER PERSONAS
// ============================================================================
export const dataRichEcommercePersona = {
    ...
    priorMediaExperience: "8 years in ecommerce marketing. Has full transaction history, customer profiles, " +
...
export const printMediaPlannerPersona = {
    ...
    industry: "finance",
    companySize: "enterprise",
    priorMediaExperience: "15 years in direct response marketing. Expert in print, direct mail, and catalog. " +
...
export const lookalikeStrategyPersona = {
    ...
    priorMediaExperience: "6 years in performance marketing. Extensive experience with Meta and Google lookalikes. " +
...
// ============================================================================
const rfmSegmentationTurns = [
    {
        turnNumber: 1,
        role: "user",
        expectedIntent: "provide_customer_data_context",
        exampleMessage: "I have 500,000 customers with 3 years of transaction history. I want to segment them " +
    ...
    },
    {
        ...
        exampleMessage: "OK, let's do this. Our recency ranges from 0 to 1095 days, frequency from 1 to 50 orders, " +
    ...
    },
    {
        ...
        exampleMessage: "Based on this segmentation, what should our marketing strategy be for each segment? " +
...
export const rfmSegmentationScenario = {
    id: "adv-rfm-segmentation-scoring",
    name: "RFM Segmentation & Scoring",
    description: "Tests agent's ability to explain and guide RFM segmentation with specific " +
...
// ============================================================================
const propensityModelTurns = [
    {
        turnNumber: 1,
        role: "user",
        expectedIntent: "request_propensity_explanation",
        exampleMessage: "I want to build a propensity model to predict which customers are likely to make " +
    ...
    },
    {
        ...
        exampleMessage: "How do we actually score customers? What score range should we use and how do we " +
    ...
    },
    {
        ...
        exampleMessage: "Given our $2M budget, how should we allocate spend across propensity tiers? " +
...
export const propensityModelScenario = {
    id: "adv-propensity-model-scoring",
    name: "Propensity Model & Scoring",
    description: "Tests agent's ability to explain propensity models, scoring methodology, " +
...
// ============================================================================
const decileAnalysisTurns = [
    {
        turnNumber: 1,
        role: "user",
        expectedIntent: "request_decile_explanation",
        exampleMessage: "I'm planning a direct mail campaign to 2 million customers. I need to use decile " +
    ...
    },
    {
        ...
        exampleMessage: "My mail piece costs $0.85 including postage and fulfillment. Average order value is " +
    ...
    },
    {
        ...
        exampleMessage: "What if I want to maximize total profit vs. maximize ROI? Show me the difference " +
...
export const decileAnalysisScenario = {
    id: "adv-decile-analysis-cutoff",
    name: "Decile Analysis & Investment Cutoffs",
    description: "Tests agent's ability to perform decile analysis for print/direct mail, " +
...
// ============================================================================
const lookalikeStrategyTurns = [
    {
        turnNumber: 1,
        role: "user",
        expectedIntent: "request_seed_guidance",
        exampleMessage: "I have 150,000 customers and want to build lookalike audiences on Meta and Google. " +
    ...
    },
    {
        ...
        exampleMessage: "If I use my top 20% customers (30,000) as my seed, what expansion percentage should " +
    ...
    },
    {
        ...
        exampleMessage: "What's the difference between Meta lookalikes and Google Similar Audiences? " +
...
export const lookalikeStrategyScenario = {
    id: "adv-lookalike-audience-strategy",
    name: "Lookalike Audience Strategy",
    description: "Tests agent's ability to guide lookalike audience creation, seed selection, " +
...
const nameFlowTurns = [
    {
        ...
        exampleMessage: "I need to map our customer journey from acquisition through loyalty. We have data on " +
    ...
    },
    {
        ...
        exampleMessage: "Based on our 500K customers, how should I expect them to distribute across stages? " +
    ...
    },
    {
        ...
        exampleMessage: "What should our marketing strategy be at each stage? How do we allocate our budget " +
...
export const nameFlowScenario = {
    id: "adv-name-flow-journey-mapping",
    name: "Name Flow & Customer Journey Mapping",
    description: "Tests agent's ability to map customer lifecycles, define stages, " +
...
// ============================================================================
const profitabilityMediaPlanTurns = [
    {
        turnNumber: 1,
        role: "user",
        expectedIntent: "provide_segment_economics",
        exampleMessage: "I have 5 RFM segments with different LTVs: Champions ($1,200 LTV), Loyal ($650 LTV), " +
    ...
    },
    {
        ...
        exampleMessage: "For each segment, what channels should we use? I want to see a segment x channel " +
    ...
    },
    {
        ...
        exampleMessage: "Pull this together into a complete media plan. Show me total expected conversions, " +
...
export const profitabilityMediaPlanScenario = {
    id: "adv-profitability-media-plan",
    name: "Profitability-Based Media Plan",
    description: "Tests agent's ability to build media plans based on segment-level " +
...
// ============================================================================
export const ADVANCED_ANALYTICS_SCENARIOS = [
...
//# sourceMappingURL=advanced-analytics-scenarios.js.map