...
exports.aggressiveKpiPersona = {
    ...
    knownData: {
        ...
        audienceDescription: "SMB logistics/shipping managers, 50-500 employees, $5M-$50M revenue, " +
    ...
    failureConditions: [
        {
            ...
            description: "Agent accepts $150 CAC target without challenging or discussing feasibility",
            type: "custom_pattern",
            severity: "critical",
            scorePenalty: 0.25,
        ...
        },
        {
            ...
            description: "Agent doesn't discuss that achieving $150 CAC may require lower volume",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.15,
            terminateOnDetect: false,
        },
        {
            ...
            description: "Agent doesn't recommend narrowing audience or channels to improve efficiency",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.15,
            terminateOnDetect: false,
        },
        {
            ...
            description: "Agent recommends broad reach strategy when aggressive efficiency requires precision",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.1,
            terminateOnDetect: false,
