...
export const efficiencyShockPersona = {
    ...
    knownData: {
        ...
        audienceDescription: "Adults aged 35-60 with families seeking life insurance coverage",
        hasGeography: true,
...
const efficiencyShockChange = {
    ...
    userMessage: "Wait, I need to stop you there. In insurance, we can't get anywhere near $50 per " +
    ...
    failureConditions: [
        {
            ...
            description: "Agent continued with $50 CAC after user said it's impossible",
            type: "custom_pattern",
            severity: "critical",
            scorePenalty: 0.30,
        ...
        },
        {
            ...
            description: "Agent did not recalculate achievable volume at realistic CAC",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.20,
            terminateOnDetect: false,
        },
        {
            ...
            description: "Agent did not walk through budget vs volume trade-offs",
            type: "custom_pattern",
            severity: "major",
            scorePenalty: 0.15,
            terminateOnDetect: false,
        ...
        customCriteria: [
            {
                ...
                evaluator: (result) => {
                    ...
                    const changeIndex = result.turns.findIndex((t) => t.userMessage.includes("$120") || t.userMessage.includes("120"));
                    if (changeIndex === -1)
                        return false;
            ...
            },
            {
                ...
                evaluator: (result) => {
                    ...
                    for (const pattern of optionPatterns) {
                        if (pattern.test(postChangeResponses))
                            optionCount++;
                    }
