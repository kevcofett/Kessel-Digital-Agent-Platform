 ...
 */
function detectsChangeAcknowledgment(response, field) {
 ...
 */
function detectsRecalculation(response, field) {
 ...
 */
function detectsImpactExplanation(response) {
 ...
 */
function detectsActionRecommendation(response) {
...
function scoreReforecasting(turns, dataRevisions) {
    ...
    for (const revision of dataRevisions) {
        ...
        const responseAfterChange = turns.find((t) => t.turnNumber > revision.turnNumber);
...
//# sourceMappingURL=reforecasting-scorers.js.map