 ...
 */
function hasTeachingIndicators(response) {
    // Explains WHY
    const whyPatterns = [
        /because/i,
        /this matters/i,
 ...
 */
function hasInterrogationPatterns(response) {
 ...
 */
export async function scoreTeachingBehavior(ctx) {
...
//# sourceMappingURL=teaching-behavior.js.map