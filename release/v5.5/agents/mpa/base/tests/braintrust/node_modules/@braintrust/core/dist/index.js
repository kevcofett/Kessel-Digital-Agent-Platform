...
var literalSchema = import_zod5.z.union([
  import_zod5.z.string().openapi({ title: "string" }),
  import_zod5.z.number().openapi({ title: "number" }),
  import_zod5.z.boolean().openapi({ title: "boolean" }),
  import_zod5.z.null().openapi({ title: "null" })
]);
var jsonSchema = import_zod5.z.lazy(
  () => import_zod5.z.union([
    literalSchema,
    import_zod5.z.array(jsonSchema).openapi({ title: "array" }),
    import_zod5.z.record(jsonSchema).openapi({ title: "object" })
  ])
);
var datetimeStringSchema = import_zod5.z.string().transform((x, ctx) => {
  const d = new Date(x);
  if (isNaN(d.getTime())) {
    ctx.addIssue({
      code: import_zod5.z.ZodIssueCode.invalid_string,
      validation: "datetime",
...
var objectTypes = import_zod5.z.enum([
  "project",
  "experiment",
  "dataset",
  "prompt",
...
var objectTypesWithEvent = import_zod5.z.enum([
  "project",
  "experiment",
  "dataset",
  "prompt",
...
var modeSchema = import_zod6.z.enum(["default", "stainless"]);
var _a;
...
var modeToTypes = {
  default: {
    unknown: import_zod6.z.unknown(),
    literalTrue: import_zod6.z.literal(true),
    literalFalse: import_zod6.z.literal(false)
  },
  stainless: {
    // Stainless requires schemas which are completely permissive to be
    // tagged.
    unknown: import_zod6.z.unknown().openapi({ ["x-stainless-any"]: true }),
    // Stainless does not support boolean literals in all SDKs.
    literalTrue: import_zod6.z.boolean(),
    literalFalse: import_zod6.z.boolean()
  }
};
...
var messageRoleSchema = import_zod7.z.enum([
  "system",
  "user",
  "assistant",
  "function",
...
var chatCompletionSystemMessageParamSchema = import_zod7.z.object({
  content: import_zod7.z.string().default(""),
  role: import_zod7.z.literal("system"),
  name: import_zod7.z.string().optional()
});
var chatCompletionContentPartTextSchema = import_zod7.z.object({
  text: import_zod7.z.string().default(""),
  type: import_zod7.z.literal("text")
});
var imageURLSchema = import_zod7.z.object({
  url: import_zod7.z.string(),
  detail: import_zod7.z.union([
    import_zod7.z.literal("auto").openapi({ title: "auto" }),
    import_zod7.z.literal("low").openapi({ title: "low" }),
    import_zod7.z.literal("high").openapi({ title: "high" })
  ]).optional()
});
var chatCompletionContentPartImageSchema = import_zod7.z.object({
  image_url: imageURLSchema,
  type: import_zod7.z.literal("image_url")
});
var chatCompletionContentPartSchema = import_zod7.z.union([
  chatCompletionContentPartTextSchema.openapi({ title: "text" }),
  chatCompletionContentPartImageSchema.openapi({ title: "image_url" })
]);
var chatCompletionContentSchema = import_zod7.z.union([
  import_zod7.z.string().default("").openapi({ title: "text" }),
  import_zod7.z.array(
...
var chatCompletionUserMessageParamSchema = import_zod7.z.object({
  content: chatCompletionContentSchema,
  role: import_zod7.z.literal("user"),
  name: import_zod7.z.string().optional()
});
var functionCallSchema = import_zod7.z.object({
  arguments: import_zod7.z.string(),
  name: import_zod7.z.string()
});
var functionSchema = import_zod7.z.object({
  arguments: import_zod7.z.string(),
  name: import_zod7.z.string()
});
var chatCompletionToolMessageParamSchema = import_zod7.z.object({
  content: import_zod7.z.string().default(""),
  role: import_zod7.z.literal("tool"),
  tool_call_id: import_zod7.z.string().default("")
});
var chatCompletionFunctionMessageParamSchema = import_zod7.z.object({
  content: import_zod7.z.string().default(""),
  name: import_zod7.z.string(),
  role: import_zod7.z.literal("function")
});
var chatCompletionMessageToolCallSchema = import_zod7.z.object({
  id: import_zod7.z.string(),
  function: functionSchema,
  type: import_zod7.z.literal("function")
});
var chatCompletionAssistantMessageParamSchema = import_zod7.z.object({
  role: import_zod7.z.literal("assistant"),
  content: import_zod7.z.string().nullish(),
  ...
  name: import_zod7.z.string().nullish().transform((x) => x != null ? x : void 0),
  tool_calls: import_zod7.z.array(chatCompletionMessageToolCallSchema).nullish().transform((x) => x != null ? x : void 0)
});
var chatCompletionFallbackMessageParamSchema = import_zod7.z.object({
...
var chatCompletionOpenAIMessageParamSchema = import_zod7.z.union([
...
var chatCompletionMessageParamSchema = import_zod7.z.union([
...
var savedFunctionIdSchema = import_zod8.z.union([
  import_zod8.z.object({
    type: import_zod8.z.literal("function"),
    id: import_zod8.z.string()
  }).openapi({ title: "function" }),
  import_zod8.z.object({
    type: import_zod8.z.literal("global"),
    name: import_zod8.z.string()
  }).openapi({ title: "global" })
]);
var extendedSavedFunctionIdSchema = savedFunctionIdSchema.or(
  import_zod8.z.object({
    type: import_zod8.z.literal("slug"),
...
var functionParametersSchema = import_zod9.z.record(customTypes.unknown);
var functionDefinitionSchema = import_zod9.z.object({
  name: import_zod9.z.string(),
  description: import_zod9.z.string().optional(),
  parameters: functionParametersSchema.optional()
});
var chatCompletionToolSchema = import_zod9.z.object({
  function: functionDefinitionSchema,
  type: import_zod9.z.literal("function")
});
var toolsSchema = import_zod9.z.array(chatCompletionToolSchema);

// typespecs/prompt.ts
var promptBlockDataSchema = import_zod10.z.union([
  import_zod10.z.object({
    type: import_zod10.z.literal("completion"),
    content: import_zod10.z.string()
  }).openapi({ title: "completion" }),
  import_zod10.z.object({
    type: import_zod10.z.literal("chat"),
    messages: import_zod10.z.array(chatCompletionMessageParamSchema),
    tools: import_zod10.z.string().optional()
  }).openapi({ title: "chat" })
]);
var braintrustModelParamsSchema = import_zod10.z.object({
  use_cache: import_zod10.z.boolean().optional()
});
var BRAINTRUST_PARAMS = Object.keys(braintrustModelParamsSchema.shape);
var openAIModelParamsSchema = import_zod10.z.object({
  temperature: import_zod10.z.number().optional(),
  top_p: import_zod10.z.number().optional(),
  max_tokens: import_zod10.z.number().optional(),
  frequency_penalty: import_zod10.z.number().optional(),
  presence_penalty: import_zod10.z.number().optional(),
  response_format: import_zod10.z.object({ type: import_zod10.z.literal("json_object") }).nullish(),
  tool_choice: import_zod10.z.union([
    import_zod10.z.literal("auto").openapi({ title: "auto" }),
    import_zod10.z.literal("none").openapi({ title: "none" }),
    import_zod10.z.object({
      type: import_zod10.z.literal("function"),
      function: import_zod10.z.object({ name: import_zod10.z.string() })
    }).openapi({ title: "function" })
  ]).optional(),
  function_call: import_zod10.z.union([
    import_zod10.z.literal("auto").openapi({ title: "auto" }),
    import_zod10.z.literal("none").openapi({ title: "none" }),
    import_zod10.z.object({
  ...
  n: import_zod10.z.number().optional(),
  stop: import_zod10.z.array(import_zod10.z.string()).optional()
});
var anthropicModelParamsSchema = import_zod10.z.object({
  max_tokens: import_zod10.z.number(),
  temperature: import_zod10.z.number(),
  top_p: import_zod10.z.number().optional(),
  top_k: import_zod10.z.number().optional(),
  stop_sequences: import_zod10.z.array(import_zod10.z.string()).optional(),
  max_tokens_to_sample: import_zod10.z.number().optional().describe("This is a legacy parameter that should not be used.")
});
var googleModelParamsSchema = import_zod10.z.object({
  temperature: import_zod10.z.number().optional(),
  maxOutputTokens: import_zod10.z.number().optional(),
  topP: import_zod10.z.number().optional(),
  topK: import_zod10.z.number().optional()
});
var windowAIModelParamsSchema = import_zod10.z.object({
  temperature: import_zod10.z.number().optional(),
  topK: import_zod10.z.number().optional()
});
var jsCompletionParamsSchema = import_zod10.z.object({});
var modelParamsSchema = import_zod10.z.union([
...
var promptOptionsSchema = import_zod10.z.object({
  model: import_zod10.z.string().optional(),
  params: modelParamsSchema.optional(),
  position: import_zod10.z.string().optional()
});
var promptDataSchema = import_zod10.z.object({
  ...
  parser: import_zod10.z.object({
    type: import_zod10.z.literal("llm_classifier"),
    use_cot: import_zod10.z.boolean(),
    choice_scores: import_zod10.z.record(import_zod10.z.number().min(0).max(1))
  }).nullish(),
  tool_functions: import_zod10.z.array(savedFunctionIdSchema).nullish(),
  origin: import_zod10.z.object({
    prompt_id: import_zod10.z.string().optional(),
    project_id: import_zod10.z.string().optional(),
    prompt_version: import_zod10.z.string().optional()
  }).nullish()
}).openapi("PromptData");

// typespecs/view.ts
var import_zod11 = require("zod");
var viewTypeEnum = import_zod11.z.enum([
  "projects",
  "logs",
  "experiments",
  "datasets",
...
var viewDataSearchSchema = import_zod11.z.object({
  filter: import_zod11.z.array(customTypes.unknown).nullish(),
  tag: import_zod11.z.array(customTypes.unknown).nullish(),
  match: import_zod11.z.array(customTypes.unknown).nullish(),
  sort: import_zod11.z.array(customTypes.unknown).nullish()
}).strip().openapi("ViewDataSearch");
var viewDataSchema = import_zod11.z.object({
  search: viewDataSearchSchema.nullish()
}).strip().openapi("ViewData");
var viewOptionsSchema = import_zod11.z.object({
  columnVisibility: import_zod11.z.record(import_zod11.z.boolean()).nullish(),
  columnOrder: import_zod11.z.array(import_zod11.z.string()).nullish(),
  columnSizing: import_zod11.z.record(import_zod11.z.number()).nullish()
}).strip().openapi("ViewOptions");

// typespecs/functions.ts
var import_zod12 = require("zod");
var validRuntimesEnum = import_zod12.z.enum(["node", "python"]);
var functionTypeEnum = import_zod12.z.enum(["llm", "scorer", "task", "tool"]);
var runtimeContextSchema = import_zod12.z.object({
  runtime: validRuntimesEnum,
  version: import_zod12.z.string()
});
var functionIdSchema = import_zod12.z.union([
  import_zod12.z.object({
    function_id: import_zod12.z.string().describe("The ID of the function"),
    version: import_zod12.z.string().optional().describe("The version of the function")
  }).describe("Function id"),
  import_zod12.z.object({
    project_name: import_zod12.z.string().describe("The name of the project containing the function"),
    slug: import_zod12.z.string().describe("The slug of the function"),
    version: import_zod12.z.string().optional().describe("The version of the function")
  }).describe("Project name and slug"),
  import_zod12.z.object({
    global_function: import_zod12.z.string().describe(
  ...
  import_zod12.z.object({
    prompt_session_id: import_zod12.z.string().describe("The ID of the prompt session"),
    prompt_session_function_id: import_zod12.z.string().describe("The ID of the function in the prompt session"),
    version: import_zod12.z.string().optional().describe("The version of the function")
  }).describe("Prompt session id"),
  import_zod12.z.object({
    inline_context: runtimeContextSchema,
    code: import_zod12.z.string().describe("The inline code to execute"),
    name: import_zod12.z.string().nullish().describe("The name of the inline code function")
  }).describe("Inline code function"),
  import_zod12.z.object({
    inline_prompt: promptDataSchema,
    name: import_zod12.z.string().nullish().describe("The name of the inline prompt")
  }).describe("Inline prompt definition")
]).describe("Options for identifying a function");
var streamingModeEnum = import_zod12.z.enum(["auto", "parallel"]);
var invokeFunctionNonIdArgsSchema = import_zod12.z.object({
  input: customTypes.unknown.optional().describe(
    "Argument to the function, which can be any JSON serializable value"
  ),
  messages: import_zod12.z.array(chatCompletionMessageParamSchema).optional().describe(
    "If the function is an LLM, additional messages to pass along to it"
  ),
  parent: import_zod12.z.union([
    import_zod12.z.object({
      object_type: import_zod12.z.enum(["project_logs", "experiment"]),
      object_id: import_zod12.z.string().describe("The id of the container object you are logging to"),
      row_ids: import_zod12.z.object({
        id: import_zod12.z.string().describe("The id of the row"),
        span_id: import_zod12.z.string().describe("The span_id of the row"),
        root_span_id: import_zod12.z.string().describe("The root_span_id of the row")
      }).nullish().describe("Identifiers for the row to to log a subspan under"),
      propagated_event: import_zod12.z.record(customTypes.unknown).nullish().describe(
        "Include these properties in every span created under this parent"
      )
    }).describe("Span parent properties").openapi({ title: "span_parent_struct" }),
    import_zod12.z.string().optional().describe(
      "The parent's span identifier, created by calling `.export()` on a span"
    )
  ]).describe("Options for tracing the function call"),
  stream: import_zod12.z.boolean().nullish().describe(
...
var runEvalSchema = import_zod12.z.object({
  project_id: import_zod12.z.string().describe("Unique identifier for the project to run the eval in"),
  data: import_zod12.z.union([
    import_zod12.z.object({
      dataset_id: import_zod12.z.string()
    }).describe("Dataset id"),
    import_zod12.z.object({
      project_name: import_zod12.z.string(),
      dataset_name: import_zod12.z.string()
    }).describe("Project and dataset name")
  ]).describe("The dataset to use"),
  task: functionIdSchema.describe("The function to evaluate"),
  scores: import_zod12.z.array(functionIdSchema).describe("The functions to score the eval on"),
  experiment_name: import_zod12.z.string().optional().describe(
...
var baseSSEEventSchema = import_zod12.z.object({
  id: import_zod12.z.string().optional(),
  data: import_zod12.z.string()
});
var sseTextEventSchema = baseSSEEventSchema.merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("text_delta")
  })
);
var sseDataEventSchema = baseSSEEventSchema.merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("json_delta")
  })
);
var sseErrorEventSchema = baseSSEEventSchema.merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("error")
  })
);
var sseProgressEventSchema = baseSSEEventSchema.merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("progress")
  })
);
var sseStartEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("start"),
    data: import_zod12.z.literal("")
  })
);
var sseDoneEventSchema = baseSSEEventSchema.omit({ data: true }).merge(
  import_zod12.z.object({
    event: import_zod12.z.literal("done"),
    data: import_zod12.z.literal("")
  })
);
var functionObjectTypeEnum = import_zod12.z.enum([
  "prompt",
  "tool",
  "scorer",
  "task"
]);
var functionFormatEnum = import_zod12.z.enum(["llm", "code", "global"]);
var functionOutputTypeEnum = import_zod12.z.enum(["completion", "score", "any"]);
var sseProgressEventDataSchema = import_zod12.z.object({
  id: import_zod12.z.string().describe("The id of the span this event is for"),
  object_type: functionObjectTypeEnum,
  format: functionFormatEnum,
  output_type: functionOutputTypeEnum,
  name: import_zod12.z.string(),
  event: import_zod12.z.enum(["text_delta", "json_delta", "error", "start", "done"]),
  data: import_zod12.z.string()
  // This is the text_delta or json_delta
});
var callEventSchema = import_zod12.z.union([
...
var scoreSchema = import_zod12.z.union([
  import_zod12.z.object({
    name: import_zod12.z.string(),
    score: import_zod12.z.number().min(0).max(1).nullable().default(null),
    // Sometimes we get an empty value over the wire
    metadata: import_zod12.z.record(customTypes.unknown).optional().transform((data) => data != null ? data : void 0)
  }),
  import_zod12.z.number().min(0).max(1),
  import_zod12.z.boolean().transform((b) => b ? 1 : 0),
  import_zod12.z.null()
]);
var ifExistsEnum = import_zod12.z.enum(["error", "ignore", "replace"]);

// typespecs/app_types.ts
(0, import_zod_to_openapi3.extendZodWithOpenApi)(import_zod13.z);
function generateBaseTableSchema(objectName, opts) {
  ...
  return import_zod13.z.object({
    id: import_zod13.z.string().uuid().describe(`Unique identifier for the ${objectName}`),
    project_id: import_zod13.z.string().uuid().describe(
      `Unique identifier for the project that the ${objectName} belongs under`
    ),
    name: import_zod13.z.string().describe(nameDescription),
    description: import_zod13.z.string().nullish().describe(`Textual description of the ${objectName}`),
    ...
    user_id: import_zod13.z.string().uuid().nullish().describe(`Identifies the user who created the ${objectName}`),
    metadata: import_zod13.z.record(customTypes.unknown).nullish().describe(`User-controlled metadata about the ${objectName}`)
  });
}
var aclObjectTypeEnum = import_zod13.z.enum([
  "organization",
  "project",
  "experiment",
  "dataset",
...
var userSchema = import_zod13.z.object({
  ...
  given_name: import_zod13.z.string().nullish().describe("Given name of the user"),
  family_name: import_zod13.z.string().nullish().describe("Family name of the user"),
  email: import_zod13.z.string().nullish().describe("The user's email"),
  avatar_url: import_zod13.z.string().nullish().describe("URL of the user's Avatar image"),
...
var organizationSchema = import_zod13.z.object({
  ...
  api_url: import_zod13.z.string().nullish(),
  is_universal_api: import_zod13.z.boolean().nullish(),
  proxy_url: import_zod13.z.string().nullish(),
  realtime_url: import_zod13.z.string().nullish(),
  created: organizationBaseSchema.shape.created
}).openapi("Organization");
var maxOverWindowSchema = import_zod13.z.object({
  window_size_days: import_zod13.z.number().int().positive(),
  max_value: import_zod13.z.number().nonnegative()
}).openapi("MaxOverWindow");
var resourcesSchema = import_zod13.z.object({
  org_id: organizationSchema.shape.id,
  forbid_toggle_experiment_public_to_private: import_zod13.z.boolean().nullish(),
  num_private_experiment_row_actions: maxOverWindowSchema.nullish(),
  forbid_insert_datasets: import_zod13.z.boolean().nullish(),
  forbid_insert_prompt_sessions: import_zod13.z.boolean().nullish(),
  forbid_access_sql_explorer: import_zod13.z.boolean().nullish(),
  num_production_log_row_actions: maxOverWindowSchema.nullish(),
  num_dataset_row_actions: maxOverWindowSchema.nullish()
}).openapi("Resources");
var memberSchema = import_zod13.z.object({
  org_id: organizationSchema.shape.id,
  user_id: userSchema.shape.id
}).openapi("Member");
var aiSecretBaseSchema = generateBaseTableSchema("AI secret");
var aiSecretSchema = import_zod13.z.object({
  id: aiSecretBaseSchema.shape.id,
  created: aiSecretBaseSchema.shape.created,
  org_id: organizationSchema.shape.id,
  name: aiSecretBaseSchema.shape.name,
  type: import_zod13.z.string().nullish(),
  metadata: import_zod13.z.record(customTypes.unknown).nullish(),
  preview_secret: import_zod13.z.string().nullish()
}).openapi("AISecret");
var envVarObjectTypeEnum = import_zod13.z.enum(["organization", "project", "function"]).describe("The type of the object the environment variable is scoped for");
var envVarBaseSchema = generateBaseTableSchema("environment variable");
var envVarSchema = import_zod13.z.object({
  id: envVarBaseSchema.shape.id,
  object_type: envVarObjectTypeEnum,
  object_id: import_zod13.z.string().uuid().describe("The id of the object the environment variable is scoped for"),
  name: import_zod13.z.string().describe("The name of the environment variable"),
...
var apiKeySchema = import_zod13.z.object({
  id: apiKeyBaseSchema.shape.id,
  created: apiKeyBaseSchema.shape.created,
  name: apiKeyBaseSchema.shape.name,
  preview_name: import_zod13.z.string(),
  user_id: userSchema.shape.id.nullish(),
  org_id: organizationSchema.shape.id.nullish()
}).openapi("ApiKey");
var projectSettingsSchema = import_zod13.z.object({
  comparison_key: import_zod13.z.string().nullish().describe("The key used to join two experiments (defaults to `input`).")
});
var projectBaseSchema = generateBaseTableSchema("project");
var projectSchema = import_zod13.z.object({
  id: projectBaseSchema.shape.id,
  org_id: import_zod13.z.string().uuid().describe(
...
var datasetSchema = import_zod13.z.object({
...
var promptLogIdLiteralSchema = import_zod13.z.literal("p").describe("A literal 'p' which identifies the object as a project prompt");
var promptBaseSchema = generateBaseTableSchema("prompt");
var promptSchemaObject = import_zod13.z.object({
  id: promptBaseSchema.shape.id,
  // This has to be copy/pasted because zod blows up when there are circular dependencies
  _xact_id: import_zod13.z.string().describe(
  ...
  slug: import_zod13.z.string().describe("Unique identifier for the prompt"),
  ...
  tags: import_zod13.z.array(import_zod13.z.string()).nullish().describe("A list of tags for the prompt"),
...
var codeBundleSchema = import_zod13.z.object({
  runtime_context: runtimeContextSchema,
  location: import_zod13.z.union([
    import_zod13.z.object({
      type: import_zod13.z.literal("experiment"),
      eval_name: import_zod13.z.string(),
      position: import_zod13.z.union([
        import_zod13.z.object({ type: import_zod13.z.literal("task") }),
        import_zod13.z.object({
          type: import_zod13.z.literal("scorer"),
          index: import_zod13.z.number().int().nonnegative()
        }).openapi({ title: "scorer" })
      ])
    }).openapi({ title: "experiment" }),
    import_zod13.z.object({
      type: import_zod13.z.literal("function"),
      index: import_zod13.z.number().int().nonnegative()
    }).openapi({ title: "function" })
  ]),
  bundle_id: import_zod13.z.string(),
  preview: import_zod13.z.string().nullish().describe("A preview of the code")
});
var functionDataSchema = import_zod13.z.union([
  import_zod13.z.object({
    type: import_zod13.z.literal("prompt")
    // For backwards compatibility reasons, the prompt definition is hoisted out and stored
    // in the outer object
  }).openapi({ title: "prompt" }),
  import_zod13.z.object({
    type: import_zod13.z.literal("code"),
    data: import_zod13.z.union([
      import_zod13.z.object({
        type: import_zod13.z.literal("bundle")
      }).and(codeBundleSchema).openapi({ title: "bundle" }),
      import_zod13.z.object({
        type: import_zod13.z.literal("inline"),
        runtime_context: runtimeContextSchema,
  ...
  import_zod13.z.object({
    type: import_zod13.z.literal("global"),
...
var functionSchema2 = promptSchemaObject.merge(
  import_zod13.z.object({
    ...
    origin: import_zod13.z.object({
      object_type: aclObjectTypeEnum,
      object_id: import_zod13.z.string().uuid().describe("Id of the object the function is originating from"),
      internal: import_zod13.z.boolean().nullish().describe(
        "The function exists for internal purposes and should not be displayed in the list of functions."
      )
    }).nullish(),
    function_schema: import_zod13.z.object({
...
var repoInfoSchema = import_zod13.z.object({
  commit: import_zod13.z.string().nullish().describe("SHA of most recent commit"),
  branch: import_zod13.z.string().nullish().describe("Name of the branch the most recent commit belongs to"),
  tag: import_zod13.z.string().nullish().describe("Name of the tag on the most recent commit"),
  dirty: import_zod13.z.boolean().nullish().describe(
    "Whether or not the repo had uncommitted changes when snapshotted"
  ),
  author_name: import_zod13.z.string().nullish().describe("Name of the author of the most recent commit"),
  author_email: import_zod13.z.string().nullish().describe("Email of the author of the most recent commit"),
  commit_message: import_zod13.z.string().nullish().describe("Most recent commit message"),
  commit_time: import_zod13.z.string().nullish().describe("Time of the most recent commit"),
  git_diff: import_zod13.z.string().nullish().describe(
...
var experimentSchema = import_zod13.z.object({
  ...
  commit: import_zod13.z.string().nullish().describe("Commit, taken directly from `repo_info.commit`"),
  base_exp_id: import_zod13.z.string().uuid().nullish().describe(
    "Id of default base experiment to compare against when viewing this experiment"
  ),
  deleted_at: experimentBaseSchema.shape.deleted_at,
  dataset_id: import_zod13.z.string().uuid().nullish().describe(
    "Identifier of the linked dataset, or null if the experiment is not linked to a dataset"
  ),
  dataset_version: import_zod13.z.string().nullish().describe(
    "Version number of the linked dataset the experiment was run against. This can be used to reproduce the experiment after the dataset has been modified."
  ),
  public: import_zod13.z.boolean().describe(
...
var promptSessionSchema = import_zod13.z.object({
...
var permissionEnum = import_zod13.z.enum([
  "create",
  "read",
  "update",
  "delete",
...
var roleSchema = import_zod13.z.object({
  id: roleBaseSchema.shape.id,
  org_id: import_zod13.z.string().uuid().nullish().describe(
    [
  ...
  member_permissions: import_zod13.z.array(
    import_zod13.z.object({
  ...
  member_roles: import_zod13.z.array(import_zod13.z.string().uuid()).nullish().describe(
    [
...
var groupSchema = import_zod13.z.object({
  ...
  member_users: import_zod13.z.array(import_zod13.z.string().uuid()).nullish().describe("Ids of users which belong to this group"),
  member_groups: import_zod13.z.array(import_zod13.z.string().uuid()).nullish().describe(
    [
...
var projectScoreTypeEnum = import_zod13.z.enum(["slider", "categorical", "weighted", "minimum", "online"]).describe("The type of the configured score");
var projectScoreCategory = import_zod13.z.object({
  name: import_zod13.z.string().describe("Name of the category"),
  value: import_zod13.z.number().describe(
    "Numerical value of the category. Must be between 0 and 1, inclusive"
  )
}).describe("For categorical-type project scores, defines a single category").openapi("ProjectScoreCategory");
var onlineScoreConfigSchema = import_zod13.z.object({
  sampling_rate: import_zod13.z.number().min(0).max(1).describe("The sampling rate for online scoring"),
  scorers: import_zod13.z.array(savedFunctionIdSchema).describe("The list of scorers to use for online scoring"),
  apply_to_root_span: import_zod13.z.boolean().nullish().describe(
    "Whether to trigger online scoring on the root span of each trace"
  ),
  apply_to_span_names: import_zod13.z.string().array().nullish().describe("Trigger online scoring on any spans with a name in this list")
}).refine((val) => {
  var _a2;
...
var projectScoreSchema = import_zod13.z.object({
  ...
  categories: import_zod13.z.union([
    projectScoreCategory.array().describe(
      "For categorical-type project scores, the list of all categories"
    ).openapi({ title: "categorical" }),
    import_zod13.z.record(import_zod13.z.number()).describe(
      "For weighted-type project scores, the weights of each score"
    ).openapi({ title: "weighted" }),
    import_zod13.z.array(import_zod13.z.string()).describe(
      "For minimum-type project scores, the list of included scores"
    ).openapi({ title: "minimum" })
  ]).nullish().openapi("ProjectScoreCategories"),
  config: import_zod13.z.object({
    multi_select: import_zod13.z.boolean().nullish(),
    destination: import_zod13.z.literal("expected").nullish(),
    online: onlineScoreConfigSchema.nullish()
  }).nullish().openapi("ProjectScoreConfig"),
  position: import_zod13.z.string().nullish().describe(
...
var projectTagSchema = import_zod13.z.object({
  ...
  color: import_zod13.z.string().nullish().describe("Color of the tag for the UI")
}).describe(
...
var viewSchema = import_zod13.z.object({
  id: viewBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod13.z.string().uuid().describe("The id of the object the view applies to"),
...
var aclSchema = import_zod13.z.object({
  id: aclBaseSchema.shape.id,
  object_type: aclObjectTypeEnum,
  object_id: import_zod13.z.string().uuid().describe("The id of the object the ACL applies to"),
  user_id: import_zod13.z.string().uuid().nullish().describe(
    "Id of the user the ACL applies to. Exactly one of `user_id` and `group_id` will be provided"
  ),
  group_id: import_zod13.z.string().uuid().nullish().describe(
  ...
  role_id: import_zod13.z.string().uuid().nullish().describe(
    "Id of the role the ACL grants. Exactly one of `permission` and `role_id` will be provided"
  ),
  _object_org_id: import_zod13.z.string().uuid().describe("The organization the ACL's referred object belongs to"),
...
var appLimitSchema = import_zod13.z.number().int().nonnegative().describe("Limit the number of objects to return");
function generateBaseTableOpSchema(objectName) {
  return import_zod13.z.object({
    org_name: import_zod13.z.string().nullish().describe(
...
var startingAfterSchema = import_zod13.z.string().uuid().describe(
  [
    "Pagination cursor id.",
    "For example, if the final item in the last page you fetched had an id of `foo`, pass `starting_after=foo` to fetch the next page. Note: you may only pass one of `starting_after` and `ending_before`"
  ].join("\n\n")
).openapi("StartingAfter");
var endingBeforeSchema = import_zod13.z.string().uuid().describe(
  [
    "Pagination cursor id.",
...
var createProjectSchema = import_zod13.z.object({
  name: projectSchema.shape.name,
  org_name: createProjectBaseSchema.shape.org_name
}).openapi("CreateProject");
var patchProjectSchema = import_zod13.z.object({
...
var createExperimentSchema = import_zod13.z.object({
  ...
  ensure_new: import_zod13.z.boolean().nullish().describe(
...
var createDatasetSchema = import_zod13.z.object({
...
var patchDatasetSchema = import_zod13.z.object({
...
var patchPromptSchema = import_zod13.z.object({
...
var patchFunctionSchema = import_zod13.z.object({
...
var createRoleSchema = import_zod13.z.object({
...
var createGroupSchema = import_zod13.z.object({
...
var aclBatchUpdateRequestSchema = import_zod13.z.object({
  add_acls: aclItemSchema.array().nullish(),
  remove_acls: aclItemSchema.array().nullish()
});
var aclBatchUpdateResponseSchema = import_zod13.z.object({
...
var createProjectTagSchema = import_zod13.z.object({
...
var patchProjectTagSchema = import_zod13.z.object({
...
var patchViewSchema = import_zod13.z.object({
...
var deleteViewSchema = import_zod13.z.object({
  object_type: viewSchema.shape.object_type,
  object_id: viewSchema.shape.object_id
}).openapi("DeleteView");
var patchOrganizationSchema = import_zod13.z.object({
...
var createApiKeySchema = import_zod13.z.object({
  name: import_zod13.z.string().describe("Name of the api key. Does not have to be unique"),
  org_name: createApiKeyBaseSchema.shape.org_name
});
var createApiKeyOutputSchema = apiKeySchema.merge(
  import_zod13.z.object({
    key: import_zod13.z.string().describe("The raw API key. It will only be exposed this one time")
  })
).openapi("CreateApiKeyOutput");
var organizationMembersSchema = import_zod13.z.object({
  members: userSchema.pick({ id: true, email: true }).array()
}).openapi("OrganizationMembers");
var patchOrganizationMembersSchema = import_zod13.z.object({
  invite_users: import_zod13.z.object({
    ...
    send_invite_emails: import_zod13.z.boolean().nullish().describe(
  ...
  remove_users: import_zod13.z.object({
  ...
  org_id: import_zod13.z.string().nullish().describe(
...
var patchOrganizationMembersOutputSchema = import_zod13.z.object({
  status: import_zod13.z.literal("success"),
  send_email_error: import_zod13.z.string().nullish().describe(
...
var deleteAISecretSchema = import_zod13.z.object({
  name: aiSecretSchema.shape.name,
  org_name: createAISecretBaseSchema.shape.org_name
});
var patchAISecretSchema = import_zod13.z.object({
  name: aiSecretSchema.shape.name.nullish(),
  type: aiSecretSchema.shape.type,
  metadata: aiSecretSchema.shape.metadata,
  secret: import_zod13.z.string().nullish()
});
var createEnvVarSchema = envVarSchema.pick({ object_type: true, object_id: true, name: true }).extend({
  value: import_zod13.z.string().nullish().describe(
...
// typespecs/api_types.ts
(0, import_zod_to_openapi4.extendZodWithOpenApi)(import_zod14.z);
var auditSourcesSchema = import_zod14.z.enum(VALID_SOURCES);
function generateBaseEventOpSchema(objectType) {
  ...
  return import_zod14.z.object({
    ...
    [TRANSACTION_ID_FIELD]: import_zod14.z.string().describe(
    ...
    tags: import_zod14.z.array(import_zod14.z.string()).nullish().describe("A list of tags to log"),
    scores: import_zod14.z.record(import_zod14.z.number().min(0).max(1).nullish()).nullish(),
    metadata: import_zod14.z.record(customTypes.unknown).nullish().describe(
      "A dictionary with additional data about the test example, model outputs, or just about anything else that's relevant, that you can use to help find and analyze examples later. For example, you could log the `prompt`, example's `id`, or anything else that would be useful to slice/dice later. The values in `metadata` can be any JSON-serializable type, but its keys must be strings"
    ),
    metrics: import_zod14.z.object({
      start: import_zod14.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event started`
      ),
      end: import_zod14.z.number().nullish().describe(
        `A unix timestamp recording when the section of code which produced the ${eventDescription} event finished`
      ),
      prompt_tokens: import_zod14.z.number().int().nullish().describe(
        `The number of tokens in the prompt used to generate the ${eventDescription} event (only set if this is an LLM span)`
      ),
      completion_tokens: import_zod14.z.number().int().nullish().describe(
        `The number of tokens in the completion generated by the model (only set if this is an LLM span)`
      ),
      tokens: import_zod14.z.number().int().nullish().describe(
    ...
    context: import_zod14.z.object({
      caller_functionname: import_zod14.z.string().nullish().describe(
        `The function in code which created the ${eventDescription} event`
      ),
      caller_filename: import_zod14.z.string().nullish().describe(
        `Name of the file in code where the ${eventDescription} event was created`
      ),
      caller_lineno: import_zod14.z.number().int().nullish().describe(
    ...
    span_id: import_zod14.z.string().describe(
    ...
    span_parents: import_zod14.z.string().array().nullish().describe(
    ...
    root_span_id: import_zod14.z.string().describe(
      `The \`span_id\` of the root of the trace this ${eventDescription} event belongs to`
    ),
    span_attributes: import_zod14.z.object({
      name: import_zod14.z.string().nullish().describe("Name of the span, for display purposes only"),
      type: import_zod14.z.enum(spanTypeAttributeValues).nullish().describe("Type of the span, for display purposes only")
    }).catchall(customTypes.unknown).nullish().describe(
      "Human-identifying attributes of the span, such as name, type, etc."
    ),
    [OBJECT_DELETE_FIELD]: import_zod14.z.boolean().nullish().describe(
...
function generateBaseEventFeedbackSchema(objectType) {
  ...
  return import_zod14.z.object({
    ...
    scores: import_zod14.z.record(import_zod14.z.number().min(0).max(1).nullish()).nullish().describe(
    ...
    tags: import_zod14.z.array(import_zod14.z.string()).nullish().describe("A list of tags to log"),
    comment: import_zod14.z.string().nullish().describe(
...
var fetchLimitSchema = import_zod14.z.number().int().nonnegative().describe(
  [
...
var maxXactIdSchema = import_zod14.z.string().describe(fetchPaginationCursorDescription);
var maxRootSpanIdSchema = import_zod14.z.string().describe(fetchPaginationCursorDescription);
var fetchPaginationCursorSchema = import_zod14.z.string().describe(
  [
...
var versionSchema = import_zod14.z.string().describe(
  [
...
var pathTypeFilterSchema = import_zod14.z.object({
  type: import_zod14.z.literal("path_lookup").describe("Denotes the type of filter as a path-lookup filter"),
  path: import_zod14.z.string().array().describe(
...
var fetchEventsRequestSchema = import_zod14.z.object({
...
function makeFetchEventsResponseSchema(objectType, eventSchema) {
  ...
  return import_zod14.z.object({
    ...
    cursor: import_zod14.z.string().nullish().describe(
      [
        "Pagination cursor",
...
var experimentEventSchema = import_zod14.z.object({
  id: experimentEventBaseSchema.shape.id,
  dataset_record_id: import_zod14.z.string().nullish().describe(
...
var datasetEventSchema = import_zod14.z.object({
...
var promptSessionEventSchema = import_zod14.z.object({
...
var projectLogsLogIdLiteralSchema = import_zod14.z.literal("g").describe("A literal 'g' which identifies the log as a project log");
var projectLogsEventSchema = import_zod14.z.object({
...
var mergeEventSchema = import_zod14.z.object({
  [IS_MERGE_FIELD]: customTypes.literalTrue.describe(isMergeDescription),
  [MERGE_PATHS_FIELD]: import_zod14.z.string().array().array().nullish().describe(
    [
...
var replacementEventSchema = import_zod14.z.object({
  [IS_MERGE_FIELD]: customTypes.literalFalse.nullish().describe(isMergeDescription),
  [PARENT_ID_FIELD]: import_zod14.z.string().nullish().describe(
    [
...
function makeInsertEventSchemas(objectType, insertSchema) {
  ...
  const eventSchema = import_zod14.z.union([replaceVariantSchema, mergeVariantSchema]).describe(`${capitalize(article)} ${eventDescription} event`).openapi(`Insert${eventSchemaName}Event`);
  const requestSchema = import_zod14.z.object({
...
var insertEventsResponseSchema = import_zod14.z.object({
  row_ids: import_zod14.z.string().array().describe(
    "The ids of all rows that were inserted, aligning one-to-one with the rows provided as input"
  )
}).openapi("InsertEventsResponse");
var feedbackResponseSchema = import_zod14.z.object({
...
function makeCrossObjectIndividualRequestSchema(objectType) {
  ...
  const insertObject = import_zod14.z.object({
  ...
  return import_zod14.z.record(import_zod14.z.string().uuid(), insertObject).nullish().describe(
...
function makeCrossObjectIndividualResponseSchema(objectType) {
  return import_zod14.z.record(import_zod14.z.string().uuid(), insertEventsResponseSchema).nullish().describe(
    `A mapping from ${objectType} id to row ids for inserted \`events\``
  );
}
var crossObjectInsertRequestSchema = import_zod14.z.object({
...
var crossObjectInsertResponseSchema = import_zod14.z.object({
...
var summarizeScoresParamSchema = import_zod14.z.boolean().describe(
  "Whether to summarize the scores and metrics. If false (or omitted), only the metadata will be returned."
);
var comparisonExperimentIdParamSchema = import_zod14.z.string().uuid().describe(
...
var summarizeDataParamSchema = import_zod14.z.boolean().describe(
  "Whether to summarize the data. If false (or omitted), only the metadata will be returned."
);
var summarizeExperimentResponseSchema = import_zod14.z.object({
  project_name: import_zod14.z.string().describe("Name of the project that the experiment belongs to"),
  experiment_name: import_zod14.z.string().describe("Name of the experiment"),
  project_url: import_zod14.z.string().url().describe("URL to the project's page in the Braintrust app"),
  experiment_url: import_zod14.z.string().url().describe("URL to the experiment's page in the Braintrust app"),
  comparison_experiment_name: import_zod14.z.string().nullish().describe("The experiment which scores are baselined against"),
  scores: import_zod14.z.record(
    import_zod14.z.object({
      name: import_zod14.z.string().describe("Name of the score"),
      score: import_zod14.z.number().min(0).max(1).describe("Average score across all examples"),
      diff: import_zod14.z.number().min(-1).max(1).optional().describe(
        "Difference in score between the current and comparison experiment"
      ),
      improvements: import_zod14.z.number().int().min(0).describe("Number of improvements in the score"),
      regressions: import_zod14.z.number().int().min(0).describe("Number of regressions in the score")
    }).describe("Summary of a score's performance").openapi("ScoreSummary")
  ).nullish().describe("Summary of the experiment's scores"),
  metrics: import_zod14.z.record(
    import_zod14.z.object({
      name: import_zod14.z.string().describe("Name of the metric"),
      metric: import_zod14.z.number().describe("Average metric across all examples"),
      unit: import_zod14.z.string().describe("Unit label for the metric"),
      diff: import_zod14.z.number().optional().describe(
        "Difference in metric between the current and comparison experiment"
      ),
      improvements: import_zod14.z.number().int().min(0).describe("Number of improvements in the metric"),
      regressions: import_zod14.z.number().int().min(0).describe("Number of regressions in the metric")
...
var summarizeDatasetResponseSchema = import_zod14.z.object({
  project_name: import_zod14.z.string().describe("Name of the project that the dataset belongs to"),
  dataset_name: import_zod14.z.string().describe("Name of the dataset"),
  project_url: import_zod14.z.string().url().describe("URL to the project's page in the Braintrust app"),
  dataset_url: import_zod14.z.string().url().describe("URL to the dataset's page in the Braintrust app"),
  data_summary: import_zod14.z.object({
    total_records: import_zod14.z.number().int().min(0).describe("Total number of records in the dataset")
...
var asyncScoringStateSchema = import_zod14.z.union([
  import_zod14.z.object({
    status: import_zod14.z.literal("enabled"),
    token: import_zod14.z.string(),
    function_ids: import_zod14.z.array(functionIdSchema).nonempty()
  }),
  // Explicitly disabled.
  import_zod14.z.object({
    status: import_zod14.z.literal("disabled")
  }),
  // Inactive but may be selected later.
  import_zod14.z.null()
]);
var asyncScoringControlSchema = import_zod14.z.discriminatedUnion("kind", [
  import_zod14.z.object({
    kind: import_zod14.z.literal("score_update"),
    token: import_zod14.z.string()
  }),
  import_zod14.z.object({
    kind: import_zod14.z.literal("state_override"),
    state: asyncScoringStateSchema
  }),
  import_zod14.z.object({
    kind: import_zod14.z.literal("state_force_reselect")
  })
]);
...
var collectMetadataEnum = import_zod15.z.enum(["all", "none", "some"]);
var gitMetadataSettingsSchema = import_zod15.z.strictObject({
  collect: collectMetadataEnum,
  fields: import_zod15.z.array(gitFieldsSchema).optional()
});
