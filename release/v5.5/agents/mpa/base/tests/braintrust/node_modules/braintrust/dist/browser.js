...
var BraintrustStream = class _BraintrustStream {
  ...
  finalValue() {
    ...
    this.memoizedFinalValue = new Promise((resolve, reject) => {
      const stream = this.stream.pipeThrough(createFinalValuePassThroughStream(resolve, reject)).pipeTo(devNullWritableStream());
    });
    return this.memoizedFinalValue;
  }
};
...
function updateSpan({
  ...
  const components = import_core.SpanComponentsV3.fromStr(exported);
