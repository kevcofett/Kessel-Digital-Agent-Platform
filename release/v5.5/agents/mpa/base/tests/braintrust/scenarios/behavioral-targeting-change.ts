 ...
 */
export const behavioralTargetingPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Fitness enthusiasts 25-55 interested in health and performance", // Initial broad
    hasGeography: true,
    geography: ["US"],
 ...
 */
const behavioralTargetingChange: DataChange = {
  triggerTurn: 7,
  ...
  userMessage:
    "Actually, I want to narrow our targeting significantly. " +
 ...
 */
export const behavioralTargetingChangeScenario: TestScenario = {
  id: "behavioral-targeting-change",
  name: "Behavioral Targeting Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals narrow behavioral targeting mid-conversation. " +
  ...
  openingMessage:
    "Hi, I'm Director of Digital Marketing at EnduraFuel Nutrition. We sell subscription-based " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with broad fitness targeting after user narrowed to marathon runners",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent did not address reduced audience size from narrower targeting",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent did not recommend how to reach the specific behavioral audience",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
