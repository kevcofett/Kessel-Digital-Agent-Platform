 ...
 */
export const intermediateUserPersona: UserPersona = {
 ...
 */
export const full10StepScenario: TestScenario = {
  id: "full-10-step",
  name: "Full 10-Step Media Planning",
  description:
    "Tests complete media planning flow through all 10 steps with an intermediate user",

  persona: intermediateUserPersona,

  openingMessage:
    "Hi! I'm the Marketing Director at HomeStyle Decor. We sell home decor and furniture online. I'm looking to build a comprehensive media plan for next year. Our annual budget is $750K and we want to acquire 15,000 new customers.",
  ...
  successCriteria: {
    ...
    customCriteria: [
      ...
      },
      {
        ...
        evaluator: (result) => {
          const transitions = result.allEvents.filter(
            (e) => e.type === "step_transition"
          );
