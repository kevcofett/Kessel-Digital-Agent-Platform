 ...
 */
export const massNationalPersona: UserPersona = {
 ...
 */
export const massNationalSimplicityScenario: TestScenario = {
  id: "mass-national-simplicity",
  name: "Mass National Campaign - Simplicity Test",
  category: "phase1-quality",
  description:
    "Tests agent's ability to handle a simple broad-reach national campaign without " +
  ...
  openingMessage:
    "Hi! I'm the VP of Brand Marketing at FreshBite Snacks. We're launching a new snack " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent tries to micro-segment a mass audience when client wants broad reach",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
    ...
    },
    {
      ...
      description:
        "Agent obsesses over CAC/ROAS for brand awareness campaign",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent introduces DMA-level complexity when national buy is appropriate",
      type: "custom_pattern",
      severity: "warning",
      scorePenalty: 0.1,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent focuses on conversion metrics instead of reach/frequency/awareness",
      type: "custom_pattern",
      severity: "warning",
      scorePenalty: 0.1,
      terminateOnDetect: false,
    ...
    customCriteria: [
      {
        ...
        evaluator: (result) => {
          ...
          const metricsFound = reachFrequencyPatterns.filter((p) =>
            p.test(allResponses)
          ).length;
      ...
      },
      {
        ...
        evaluator: (result) => {
          ...
          const metricsFound = brandMetricPatterns.filter((p) =>
            p.test(allResponses)
          ).length;
      ...
      },
      {
        ...
        evaluator: (result) => {
          ...
          const channelsFound = broadReachChannels.filter((p) =>
            p.test(allResponses)
          ).length;
...
export const massNationalSimplicityContext = {
  ...
  kpiAggressiveness: "conservative" as const,
