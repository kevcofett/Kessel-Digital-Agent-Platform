 ...
 */
export const outcomeKPIPersona: UserPersona = {
  ...
  knownData: {
    ...
    audienceDescription:
      "Homeowners 35-65 with household income $100K+, life events (new home, new baby, retirement)",
    hasGeography: true,
 ...
 */
const outcomeKPIChange: DataChange = {
  triggerTurn: 8,
  field: "objective",
  oldValue: {
    type: "acquisition",
  ...
  userMessage:
    "I need to share some news from our executive team. " +
 ...
 */
export const outcomeKPIChangeScenario: TestScenario = {
  id: "outcome-kpi-change",
  name: "Outcome KPI Change",
  category: "reforecasting",
  description:
    "Tests proactive reforecasting when user reveals fundamental objective shift mid-conversation. " +
  ...
  openingMessage:
    "Hi, I'm Head of Marketing at TrustGuard Insurance. " +
  ...
  failureConditions: [
    {
      ...
      description:
        "Agent continues with acquisition strategy after user shifted to awareness",
      type: "custom_pattern",
      severity: "critical",
      scorePenalty: 0.30,
    ...
    },
    {
      ...
      description:
        "Agent acknowledged shift but did not restructure channel mix for awareness",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.20,
      terminateOnDetect: false,
    },
    {
      ...
      description:
        "Agent continued using acquisition metrics (CPA, policies) for awareness goal",
      type: "custom_pattern",
      severity: "major",
      scorePenalty: 0.15,
      terminateOnDetect: false,
...
export const outcomeKPIChangeContext = {
  budget: 5000000,
  funnel: "awareness" as const, // Final state
