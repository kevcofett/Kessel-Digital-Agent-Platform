 ...
 */
function hasSufficientDataForCalculation(ctx: ProactiveCalculationContext): boolean {
 ...
 */
function hasCalculationOnOwnLine(response: string): boolean {
 ...
 */
function hasBenchmarkComparison(response: string): boolean {
 ...
 */
function hasImplicationStatement(response: string): boolean {
 ...
 */
export async function scoreProactiveCalculation(
  ctx: ProactiveCalculationContext
): Promise<JudgeResult> {
