 ...
 */
export function scoreCalculationPresence(output: string): TurnScore {
  ...
  let score = 0;
  if (hasCalculation) score = 1.0;
  else if (hasPercentage) score = 0.7;
  else score = 0.5; // Neutral - calculation may not be applicable
