...
Copy and paste this prompt into Claude Code in VS Code within the Mastercard environment:
...
After import, I need to set these environment variables in Power Apps:
