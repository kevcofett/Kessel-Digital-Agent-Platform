...
|----------|------|---------|
| MPA_Architecture_v6.0.md | 88KB | Authoritative architecture |
| MPA_Dataverse_Schema_v6.0.md | 54KB | Schema definitions |
| MPA_AI_Builder_Prompts_v6.0.md | 58KB | AI Builder prompts |
| MPA_Azure_Functions_v6.0.md | 82KB | Azure Functions spec |
| MPA_CA_Framework_Expansion_v6.0.md | 30KB | CA expansion plan |
