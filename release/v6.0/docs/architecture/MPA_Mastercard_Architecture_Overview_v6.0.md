...
| Document | Location |
|----------|----------|
| Dataverse Schema | `release/v6.0/docs/architecture/MPA_Dataverse_Schema_v6.0.md` |
| AI Builder Prompts | `release/v6.0/docs/architecture/MPA_AI_Builder_Prompts_v6.0.md` |
