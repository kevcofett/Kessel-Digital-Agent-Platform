...
- **MPA_Architecture_v6.0.md** - Complete architecture specification
- **MPA_Dataverse_Schema_v6.0.md** - Database schema details
- **MPA_AI_Builder_Prompts_v6.0.md** - Prompt specifications
- **MPA_Azure_Functions_v6.0.md** - Function specifications (Personal only)
...
3. Enter prompt details from MPA_AI_Builder_Prompts_v6.0.md:
...
# (Files from MPA_Azure_Functions_v6.0.md)
```
