...
1. **MPA_Architecture_v7.0.md** - Complete architecture with capability abstraction
2. **MPA_Dataverse_Schema_v7.0.md** - All tables with full column definitions
3. **MPA_AI_Builder_Prompts_v7.0.md** - Detailed prompt specifications
4. **MPA_Azure_Functions_v7.0.md** - Function specs (personal environment)
